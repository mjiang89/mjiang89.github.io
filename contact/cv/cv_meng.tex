...
\moveleft.5\hoffset\centerline{\Large\bf Meng Jiang}
...
{Google Scholar: \#citation = 505 (311 as the first author), h-index = 9}
...
$\bullet$ {\em Methodology:} from observation, representation to models and algorithms; \\
$\bullet$ {\em Applications:} behavior prediction, recommender systems, anti-fraud systems, etc. \\
