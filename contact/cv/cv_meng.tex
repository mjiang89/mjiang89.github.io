...
{Google Scholar: \#citation = 519 (324 as the first author), h-index = 9}
...
Given massive behavior data (user-item interaction), I study
\begin{itemize} \itemsep -2pt
	\item Mining user-item behavior network with social, spatiotemporal contexts;
