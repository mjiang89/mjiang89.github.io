...
\fancypagestyle{firststyle}
{
   ...
   \fancyhead[R]{\vspace{-2cm}\footnotesize Last updated April 1, 2022}
}
...
\bf{Ph.D.}&Tsinghua University, Computer Science&2015\\
 &\multicolumn{2}{l}{Thesis: \textit{Modeling Complex User Behaviors in Social Media}}\\
 &\multicolumn{2}{l}{Graduated with honors}\\
...
\item[J31] @Wang, D., @Zhao, T., @Yu, W., Chawla, N.V., \textbf{Jiang, M.} ``Deep Multimodal Complementarity Learning'', under review at \textit{IEEE Transactions on Neural Networks and Learning Systems}. In press. (IF=8.793)
