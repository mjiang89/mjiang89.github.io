...
\fancypagestyle{firststyle}
{
   ...
   \fancyhead[R]{\vspace{-2cm}\footnotesize Last updated July 1, 2019}
}
...
\item[C30] Wang, T., Xu, X., Xiong, J., Jiang, M., Shi, Y. ``MSU-Net: Multiscale Statistical U-Net forReal-time 3D Cardiac MRI Video Segmentation'', under review at International Conference on Medical Image Computing and Computer Assisted Intervention (MICCAI), October 2019. (in press, acceptance rate 31\%)		
...
\item[CR8] *Yu, W., *Shu, Y., @Zeng, Q., Jiang, M. ``Experimental Evidence Extraction in Data Science with Hybrid Table Features and Ensemble Learning'', under review at ACM International Conference on Information and Knowledge Management (CIKM), 2019.

\item[CR7] @Ding, Y., @Wang, D., Jiang, M. ``Preserving Composition and Crystal Structure Information of Chemical Compounds in Atomic Embedding'', under review at ACM International Conference on Information and Knowledge Management (CIKM), 2019.

\item[CR6] Tang, P., Jiang, M., Xia, N., Pitera, J., Welser, J., Chawla, N.V. ``Multi-label Patent Categorization with Non-local Attention-based Graph Convolutional Network'', under review at International Conference on Data Mining (ICDM), 2019.

\item[CR5] @Wang, D., @Zhao, T., @Jiang, T., Chawla, N.V., Jiang, M. ``Evolutionary Graph Neural Networks'', under review at Annual Conference on Neural Information Processing Systems (NeurIPS), 2019.

\item[CR4] Yao, H., Zhang, C., Wei, Y., Jiang, M., Wang, S., Chawla, N.V., Li, Z. ``Graph Few-shot Learning via Knowledge Transfer'', under review at Annual Conference on Neural Information Processing Systems (NeurIPS), 2019.

\item[CR3] @Jiang, T., @Zhao, T., Qin, B., Liu, T., Chawla, N.V., Jiang, M. ``Canonicalizing Open Knowledge Bases with Multi-layered Meta-graph Neural Network'', under review at Conference on Empirical Methods in Natural Language Processing (EMNLP), 2019.

\item[CR2] @Jiang, T., @Zhao, T., Qin, B., Liu, T., Chawla, N.V., Jiang, M. ``Multi-input Multi-output Sequence Labeling for Joint Extraction of Fact and Condition Tuples from Scientific Text'', under review at Conference on Empirical Methods in Natural Language Processing (EMNLP), 2019.
	
\item[CR1] Zhang, C., Yao, H., Jiang, M., Li, Z., Chawla, N.V. ``Few-Shot Knowledge Base Completion'', under review at Conference on Empirical Methods in Natural Language Processing (EMNLP), 2019.
