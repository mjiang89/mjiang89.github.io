...
\fancypagestyle{firststyle}
{
   ...
   \fancyhead[R]{\vspace{-2cm}\footnotesize Last updated May 31, 2022}
}
...
\hspace{-0.75cm}External funds: Total amount: \$4,039,034; Total credit: \textbf{\$2,146,695}
...
(Highly Competitive; Award abstract requested by Program Contact) \\
...
\item[C69] @Zhao, T., @Liu, G., @Wang, D., @Yu, W., \textbf{Jiang, M.} ``Learning from Counterfactual Graph for Link Prediction'', in Proceedings of \textit{International Conference on Machine Learning} (ICML), 2022. (Acceptance rate 21.9\% = 1235/5630)
...
%\item[CR3] @Hu, Z., \textbf{Jiang, M.} ``Solving Math Word Problems Automatically with Heterogeneous Line Graph Transformer for Online Learning'', under review at \textit{} (), 2023.

%\item[CR2] @Zhao, T., Tang, X., Zhang, D., Rao, N., Song, Y., Agrawal, P., Subbian, K., Yin, B., \textbf{Jiang, M.} ``AutoGDA: Automated Graph Data Augmentation for Node Classification'', under review at \textit{} , 2023.
		
%\item[CR1] Wu, Z., \textbf{Jiang, M.}, Shen, C. ``Learning Multivariable Logic Rules on Knowledge Graphs'', under review at \textit{} (), 2022.
