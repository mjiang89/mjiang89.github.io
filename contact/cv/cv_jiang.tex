...
{Google Scholar: \#citation = \textbf{1160}, H-index = \textbf{15}}
\begin{itemize}
...
[C22] Fangbo Tao, Chao Zhang, Xiusi Chen, \textbf{Meng Jiang}, Tim Hanratty, Lance Kaplan and Jiawei Han. ``Doc2Cube: Automated Document Allocation to Text Cube via Dimension-Aware Joint Embedding'', in IEEE International Conference on Data Mining (\textbf{ICDM}), 2018.
