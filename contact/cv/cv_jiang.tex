...
\fancypagestyle{firststyle}
{
   ...
   \fancyhead[R]{\vspace{-2cm}\footnotesize Last updated September 21, 2021}
}
...
\item[CR3] @Zhao, T., Tang, X., Zhang, D., Rao, N., Song, Y., Agrawal, P., Subbian, K., Yin, B., \textbf{Jiang, M.} ``Automated Graph Data Augmentation for Node Classification'', under review at \textit{AAAI Conference on Artificial Intelligence} (AAAI), 2022.	
