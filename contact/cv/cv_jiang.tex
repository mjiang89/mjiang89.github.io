...
\fancypagestyle{firststyle}
{
   ...
   \fancyhead[R]{\vspace{-2cm}\footnotesize Last updated May 25, 2021}
}
...
\item[WR3] @Zeng, Q., Lin, J., Yu, W., Cleland-Huang, J., \textbf{Jiang, M.} ``Boosting Taxonomy Completion with Concept Generation'', under review at the \textit{International Workshop on Data Mining in Bioinformatics} (BIOKDD) in conjunction with \textit{ACM SIGKDD International Conference on Knowledge Discovery and Data Mining} (KDD), 2021.
		
\item[WR2] @Wang, D., @Zhao, T., Chawla, N.V., \textbf{Jiang, M.} ``Evolutionary Graph Normalizing Flows'', under review at the \textit{International Workshop on Deep Learning on Graphs: Methods and Applications} (DLG) in conjunction with \textit{ACM SIGKDD International Conference on Knowledge Discovery and Data Mining} (KDD), 2021.
		
\item[WR1] *Kuebler, J., @Tong, L., \textbf{Jiang, M.} ``Multi-Round Parsing-based Multiword Rules for Scientific OpenIE'', under review at the \textit{Workshop on Multiword Expressions} (MWE) in conjunction with \textit{Annual Meeting of the Association for Computational Linguistics} (ACL), 2021.
