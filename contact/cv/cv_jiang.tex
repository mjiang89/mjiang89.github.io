...
\item[CR6] @Zhao, T., @Liu, G., Günnemann, S., \textbf{Jiang, M.} ``Graph Data Augmentation for Graph Machine Learning: A Survey'', under review at \textit{International Joint Conference on Artificial Intelligence} (IJCAI), 2022.

\item[CR5] @Zhao, T., Tang, X., Zhang, D., Rao, N., Song, Y., Agrawal, P., Subbian, K., Yin, B., \textbf{Jiang, M.} ``AutoGDA: Automated Graph Data Augmentation for Node Classification'', under review at \textit{ACM SIGKDD International Conference on Knowledge Discovery and Data Mining} (KDD), 2022.

\item[CR4] @Liu, G., @Zhao, T., Xu, J., Luo, T., \textbf{Jiang, M.} ``Graph Rationalization with Environment-based Augmentations'', under review at \textit{ACM SIGKDD International Conference on Knowledge Discovery and Data Mining} (KDD), 2022.

\item[CR3] @Hu, Z., \textbf{Jiang, M.} ``Solving Math Word Problems Automatically with Heterogeneous Line Graph Transformer for Online Learning'', under review at \textit{ACM SIGKDD International Conference on Knowledge Discovery and Data Mining} (KDD), 2022.

\item[CR2] Guo, X., @Zeng, Q., \textbf{Jiang, M.}, Yun, X., Long, B., Wu, L. ``Automatic Controllable Product Copywriting for E-Commerce'', under review at \textit{ACM SIGKDD International Conference on Knowledge Discovery and Data Mining} (KDD), 2022.

\item[CR1] @Zhao, T., @Liu, G., @Wang, D., @Yu, W., \textbf{Jiang, M.} ``Learning from Counterfactual Graph for Link Prediction'', under review at \textit{International Conference on Machine Learning} (ICML), 2022.
...
\item[JR1] @Zhang, Z., @Yu, W., \textbf{Jiang, M.} ``Recent Advances of Multi-task Learning in NLP: Regarding Task Relatedness and Training Methods'', under review at \textit{ACL Rolling Review February 2022}.
...
\hspace{-0.75cm}{\bf (Senior) Program Committee / Reviewer / Area Chair}
...
\hspace{-0.75cm}The Web Conference (WebConf/WWW): \\
(PC: 2018--2022)
...
(Reviewer: 2018--2020; Area Chair: 2021)
