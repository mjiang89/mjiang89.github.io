...
%\item[CR] @Zhao, T., Liu, Y., Woodford, O., Neves, L., \textbf{Jiang, M.}, Shah, N. ``Improving Graph Neural Network Generalization with Data Augmentation'', under review at \textit{} (), 2021.
...
%\item[CR] Zhu, C., Hinthorn, W., Xu, R., @Zeng, Q., Zeng, M., Huang, X., \textbf{Jiang, M.} ``Boosting Factual Correctness of Abstractive Summarization with Knowledge Graph'', under review at \textit{} (), 2020.
...
\item[CR12] Huang, C., Li, R., Zhang, C., \textbf{Jiang, M.}, Dai, P., Bo, L., Chawla, N.V. ``Multi-Grained Learning of Temporal Hierarchy for Time Series Forecasting'', under review at \textit{AAAI Conference on Artificial Intelligence} (AAAI), 2021.
