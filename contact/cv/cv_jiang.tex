...
\item[CR1] @Anuyah, O., @Douailly-Backman, J.-P., Metoyer, R., \textbf{Jiang, M.} ``Modeling User Behaviors to Predict HatefulnessLevel of Posts on Gap'', under review at \textit{IEEE International Conference on Big Data} (BigData), 2020.
