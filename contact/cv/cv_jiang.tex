...
\fancypagestyle{firststyle}
{
   ...
   \fancyhead[R]{\vspace{-2cm}\footnotesize Last updated May 17, 2022}
}
...
\hspace{-0.75cm}External funds: Total amount: \$4,023,052; Total credit: \textbf{\$2,130,704}
...
\item[CR5] Wu, Z., \textbf{Jiang, M.}, Shen, C. ``Learning Multivariable Logic Rules on Knowledge Graphs'', under review at \textit{Conference on Neural Information Processing Systems} (NeurIPS), 2022.
