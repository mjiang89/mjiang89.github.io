...
\fancypagestyle{firststyle}
{
   ...
   \fancyhead[R]{\vspace{-2cm}\footnotesize Last updated October 14, 2021}
}
...
\item[P29] *Kuebler, J., @Tong, L., \textbf{Jiang, M.} ``Multi-Round Parsing-based Multiword Rules for Scientific OpenIE'', in \textit{arXiv preprint arXiv:2108.02074}, August 2021. (accepted in ICBK 2021)
...
\item[CR4] @Zhao, T., Tang, X., Zhang, D., Rao, N., Song, Y., Agrawal, P., Subbian, K., Yin, B., \textbf{Jiang, M.} ``Automated Graph Data Augmentation for Node Classification'', under review at \textit{The Web Conference} (TheWebConf), 2022.
