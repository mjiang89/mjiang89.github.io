...
\fancypagestyle{firststyle}
{
   ...
   \fancyhead[R]{\vspace{-2cm}\footnotesize Last updated February 17, 2022}
}
...
\hspace{-0.75cm}External fund: Total amount: \$2,238,334; Total credit: \textbf{\$810,736}
...
Role: {ND Lead PI} with Yun Huang (UIUC, lead PI) and Qi Wang (Gallaudet Univ.)
...
Role: {PI} with Jane Cleland-Huang (ND, lead PI) and Ronald Metoyer (ND)
...
Role: {PI} with Nitesh Chawla (ND, lead PI)
...
Amount: \$43,811 (ND Research) (Credit: 76\%; \textbf{\$33,281}) \\
Role: {ND CSE Lead PI} with Liang Cai (ND History)
...
%\item[CR] @Yu, W., Zhu, C., Qin, L., @Zhao, T. \textbf{Jiang, M.} ``Diverse Generative Reasoning on Commonsense Knowledge Graphs'', under review at \textit{Annual Meeting of the Association for Computational Linguistics} (ACL), 2022.

%\item[CR] @Yu, W., Zhu, C., Fang, Y., Yu, D., Wang, S., Xu, Y., Zeng, M., \textbf{Jiang, M.} ``Dict-BERT: Enhancing Language Model Pre-training with Dictionary'', under review at \textit{Annual Meeting of the Association for Computational Linguistics} (ACL), 2022.
...
%\item[CR] @Hu, Z., \textbf{Jiang, M.} ``Heterogeneous Line Graph Transformer for Math Word Problem'', under review at \textit{ACM SIGKDD International Conference on Knowledge Discovery and Data Mining} (KDD), 2022.
