...
\fancypagestyle{firststyle}
{
   ...
   \fancyhead[R]{\vspace{-2cm}\footnotesize Last updated October 10, 2021}
}
...
%\item[CR] @Yu, W., Zhu, C., Qin, L., @Zhao, T. \textbf{Jiang, M.} ``Diverse Generative Reasoning on Commonsense Knowledge Graphs'', under review at \textit{} (), 2021.
...
\item[CR3] @Zhao, T., @Liu, G., @Wang, D., @Yu, W., \textbf{Jiang, M.} ``Counterfactual Graph Learning for Link Prediction'', under review at \textit{International Conference on Learning Representations} (ICLR), 2022.
		
\item[CR2] @Yu, W., Zhu, C., Fang, Y., Yu, D., Wang, S., Xu, Y., Zeng, M., \textbf{Jiang, M.} ``Dict-BERT: Enhancing Language Model Pre-training with Dictionary'', under review at \textit{International Conference on Learning Representations} (ICLR), 2022.

\item[CR1] @Zhao, T., Tang, X., Zhang, D., Rao, N., Song, Y., Agrawal, P., Subbian, K., Yin, B., \textbf{Jiang, M.} ``Automated Graph Data Augmentation for Node Classification'', under review at \textit{AAAI Conference on Artificial Intelligence} (AAAI), 2022.
