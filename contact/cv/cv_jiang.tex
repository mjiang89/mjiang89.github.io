...
\item[CR3] @Yu, W., Zhu, C., Fang, Y., Yu, D., Wang, S., Xu, Y., Zeng, M., \textbf{Jiang, M.} ``Dict-BERT: Enhancing Language Model Pre-training with Dictionary'', under review at \textit{International Conference on Learning Representations} (ICLR), 2022.

\item[CR2] @Zhao, T., Tang, X., Zhang, D., Rao, N., Song, Y., Agrawal, P., Subbian, K., Yin, B., \textbf{Jiang, M.} ``Automated Graph Data Augmentation for Node Classification'', under review at \textit{AAAI Conference on Artificial Intelligence} (AAAI), 2022.	
