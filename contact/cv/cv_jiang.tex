...
\fancypagestyle{firststyle}
{
   ...
   \fancyhead[R]{\vspace{-2cm}\footnotesize Last updated September 15, 2020}
}
...
\item[P15] *Chou, D., \textbf{Jiang, M.} ``Data-Driven Network Intrusion Detection: A Taxonomy of Challenges and Methods'', in \textit{arXiv preprint arXiv:20XX.XXXXX}, September 2020.
...
\item[JR7] *Chou, D., \textbf{Jiang, M.} ``Data-Driven Network Intrusion Detection: A Taxonomy of Challenges and Methods'', under review at \textit{ACM Computing Surveys}. (IF=6.131)
