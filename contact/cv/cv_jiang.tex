...
\fancypagestyle{firststyle}
{
   ...
   \fancyhead[R]{\vspace{-2cm}\footnotesize Last updated September 9, 2020}
}
...
\item[CR18] Huang, C., Li, R., Zhang, C., \textbf{Jiang, M.}, Dai, P., Bo, L., Chawla, N.V. ``Multi-Grained Learning of Temporal Hierarchy for Time Series Forecasting'', under review at \textit{AAAI Conference on Artificial Intelligence} (AAAI), 2021.

\item[CR17] \textbf{Jiang, M.}, Jung, T., Karl, R., @Zhao, T. ``Federated Dynamic GNN with Secure Aggregation'', under review at \textit{AAAI Conference on Artificial Intelligence} (AAAI), 2021.
