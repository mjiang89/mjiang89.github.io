...
\fancypagestyle{firststyle}
{
   ...
   \fancyhead[R]{\vspace{-2cm}\footnotesize Last updated March 25, 2021}
}
...
\item[CR7] @Yu, W., \textbf{Jiang, M.} ``A Structured Review of Multi-task Neural Training in NLP'', under review at \textit{the 30th International Joint Conference on Artificial Intelligence} (IJCAI), 2021. (Survey track)
		
\item[CR6] \textbf{Jiang, M.} ``Cross-Network Learning with Partially Aligned Graph Convolutional Networks'', \textit{ACM SIGKDD International Conference on Knowledge Discovery and Data Mining} (KDD), 2021.

\item[CR5] @Zeng, Q., Lin, J., Yu, W., Cleland-Huang, J., \textbf{Jiang, M.} ``Enhancing Taxonomy Completion with Concept Generation via Fusing Relational Representations'', \textit{ACM SIGKDD International Conference on Knowledge Discovery and Data Mining} (KDD), 2021.

\item[CR4] @Zhao, T., *Ni, B., @Yu, W., Guo, Z., Shah, N., \textbf{Jiang, M.} ``Action Sequence Augmentation for Early Graph-based Anomaly Detection'', under review at \textit{ACM SIGKDD International Conference on Knowledge Discovery and Data Mining} (KDD), 2021.

\item[CR3] @Yu, W., Zhu, C., @Zhao, T., Guo, Z., \textbf{Jiang, M.} ``Sentence-Permuted Paragraph Generation'', under review at \textit{Annual Meeting of the Association for Computational Linguistics} (ACL), 2021.

\item[CR2] *Dong, X., @Yu, W., Zhu, C., \textbf{Jiang, M.} ``Enhancing News Generation with Entity Class Information'', under review at \textit{Annual Meeting of the Association for Computational Linguistics} (ACL), 2021.
...
%@Anuyah, O., @Douailly-Backman, J.-P., Metoyer, R., \textbf{Jiang, M.} ``Modeling User Behaviors to Predict Hatefulness Level of Posts on Gab'', under review at \textit{} (), 2021.
