...
\fancypagestyle{firststyle}
{
   ...
   \fancyhead[R]{\vspace{-2cm}\footnotesize Last updated September 1, 2020}
}
...
\item[CR22] Huang, C., Li, R., Zhang, C., \textbf{Jiang, M.}, Dai, P., Bo, L., Chawla, N.V. ``Multi-Grained Learning of Temporal Hierarchy for Time Series Forecasting'', under review at \textit{AAAI Conference on Artificial Intelligence} (AAAI), 2021.
		
\item[CR21] \textbf{Jiang, M.}, Jung, T., Karl, R., @Zhao, T. ``Federated Dynamic GNN with Secure Aggregation'', under review at \textit{AAAI Conference on Artificial Intelligence} (AAAI), 2021.
		
\item[CR20] @Zeng, Q., Lin, J., Yu, W., Cleland-Huang, J., \textbf{Jiang, M.} ``Generating Ontologies When Concepts Cannot Be Found in Corpus'', under review at \textit{AAAI Conference on Artificial Intelligence} (AAAI), 2021.

\item[CR19] Zhang, C., Yu, L., Saebi, M., Guo, Z., \textbf{Jiang, M.}, Chawla, N.V. ``Multi-Hop Meta Relation Learning for Knowledge Bases'', under review at \textit{AAAI Conference on Artificial Intelligence} (AAAI), 2021.

\item[CR18] @Yu, W., Wu, L., @Zeng, Q., Deng, Y., Mahindru, R., Guven, S., \textbf{Jiang, M.} ``Technical Question Answering across Tasks and Domains'', under review at \textit{AAAI Conference on Artificial Intelligence} (AAAI), 2021.	

\item[CR17] Lu, Q., Jiang, W., Zhao, Z., \textbf{Jiang, M.}, Hu, J., Dasgupta, S., Shi, Y. ``Hardware and Neural Architecture Joint Search for Graph Neural Networks'', under review at \textit{AAAI Conference on Artificial Intelligence} (AAAI), 2021.

\item[CR16] Guo, Z., Zhang, C., @Yu, W., Herr, J., Wiest, O., \textbf{Jiang, M.}, Chawla, N.V. ``Task-similarity Aware Meta-transfer Learning for Molecular Property Prediction'', under review at \textit{AAAI Conference on Artificial Intelligence} (AAAI), 2021.

\item[CR15] Jiang, T., Liu, M., \textbf{Jiang, M.}, Huang, J., Qin, B. ``Relation Inquiry: A Novel Synchronous Joint Extractor for Entities and Relations'', under review at \textit{AAAI Conference on Artificial Intelligence} (AAAI), 2021.

\item[CR14] Schnur, J., Karl, R., Garcia-Martinez, A., \textbf{Jiang, M.}, Chawla, N.V. ``Imputing Growth Snapshot Similarity in Early Childhood Development: A Tensor Decomposition Approach'', under review at \textit{IEEE International Conference on Bioinformatics and Biomedicine} (BIBM), 2020.

\item[CR13] Jiang, T., Zhang, N., Liu, M., \textbf{Jiang, M.}, Liu, T., Qin, B. ``Use of Internal Knowledge: Biomedical Literature Search Liberated From External Resources'', under review at \textit{IEEE International Conference on Bioinformatics and Biomedicine} (BIBM), 2020.

\item[CR12] @Anuyah, O., @Douailly-Backman, J.-P., Metoyer, R., \textbf{Jiang, M.} ``Modeling User Behaviors to Predict HatefulnessLevel of Posts on Gap'', under review at \textit{IEEE International Conference on Big Data} (BigData), 2020.
		
\item[CR11] @Zhao, T., *Ni, B., @Yu, W., \textbf{Jiang, M.} ``Early Fraud Detection by Learning and Forecasting Behavior'', under review at \textit{ACM International Conference on Web Search and Data Mining} (WSDM), 2020.

\item[CR10] Syed, M., @Wang, D., \textbf{Jiang, M.}, Conway, O., Juneja, V., Subramanian, S., Chawla, N.V. ``Unified Representation of Twitter and Online News using Graph and Entities'', under review at \textit{ACM International Conference on Web Search and Data Mining} (WSDM), 2020.

\item[CR9] Liu, Z., \textbf{Jiang, M.}, Luo, T. ``Leverage Electron Properties to Predict Phonon Properties via Transfer Learning for Semiconductors'', under review at \textit{ASME's International Mechanical Engineering Congress and Exposition} (IMECE), 2020. (abstract)

\item[CR8] @Zhao, T., Liu, Y., Woodford, O., Neves, L., \textbf{Jiang, M.}, Shah, N. ``Improving Graph Neural Network Generalization with Data Augmentation'', under review at \textit{Conference on Neural Information Processing Systems} (NeurIPS), 2020.

\item[CR7] @Yu, W., Wu, L., Deng, Y., Mahindru, R., @Zeng, Q., Guven, S., \textbf{Jiang, M.} ``A Technical Question Answering System with Transfer Learning'', under review at \textit{Conference on Empirical Methods in Natural Language Processing} (EMNLP), 2020. (demo)

\item[CR6] *Dong, X., @Yu, W., Zhu, C., \textbf{Jiang, M.} ``Injecting Entity Types into Entity-Guided News Generation'', under review at \textit{Conference on Empirical Methods in Natural Language Processing} (EMNLP), 2020.

\item[CR5] Zhu, C., Hinthorn, W., Xu, R., @Zeng, Q., Zeng, M., Huang, X., \textbf{Jiang, M.} ``Boosting Factual Correctness of Abstractive Summarization with Knowledge Graph'', under review at \textit{Conference on Empirical Methods in Natural Language Processing} (EMNLP), 2020.

\item[CR4] @Zeng, Q., @Yu, W., *Yu, M., @Jiang, T., Weninger, T., \textbf{Jiang, M.} ``Tri-Train: Automatic Pre-fine Tuning between Pre-training and Fine-tune Training for SciNER'', under review at \textit{Conference on Empirical Methods in Natural Language Processing} (EMNLP), 2020.

\item[CR3] @Zeng, Q., *Yu, M., @Yu, W., @Jiang, T., Weninger, T., \textbf{Jiang, M.} ``Validating Label Consistency in NER Data Annotation'', under review at \textit{Conference on Empirical Methods in Natural Language Processing} (EMNLP), 2020.
