...
%\item[] @Wang, D., *Zhang, Z., *Ma, Y., @Zhao, T., @Jiang, T., Chawla, N.V., \textbf{Jiang, M.} ``CoEvoGNNs: Modeling Co-evolution of Attributed and Structural Information in Dynamic Graph Sequence'', under review at \textit{???} (???), 2020.
	
\item[CR13] @Zhao, T., Liu, Y., Woodford, O., Neves, L., \textbf{Jiang, M.}, Shah, N. ``Improving Graph Neural Network Generalization with Data Augmentation'', under review at \textit{Conference on Neural Information Processing Systems} (NeurIPS), 2020.

\item[CR12] \textbf{Jiang, M.}, Jung, T., Karl, R., @Zhao, T. ``Federated Dynamic GNN with Secure Aggregation'', under review at \textit{Conference on Neural Information Processing Systems} (NeurIPS), 2020.

\item[CR11] @Yu, W., Wu, L., Deng, Y., Mahindru, R., @Zeng, Q., Guven, S., \textbf{Jiang, M.} ``A Technical Question Answering System with Transfer Learning'', under review at \textit{Conference on Empirical Methods in Natural Language Processing} (EMNLP), 2020. (Demo track)
	
\item[CR10] @Yu, W., Wu, L., Deng, Y., Mahindru, R., @Zeng, Q., Guven, S., \textbf{Jiang, M.} ``Technical Question Answering across Tasks and Domains'', under review at \textit{Conference on Empirical Methods in Natural Language Processing} (EMNLP), 2020.

\item[CR9] *Dong, X., @Yu, W., Zhu, C., \textbf{Jiang, M.} ``Injecting Entity Types into Entity-Guided News Generation'', under review at \textit{Conference on Empirical Methods in Natural Language Processing} (EMNLP), 2020.

\item[CR8] Zhu, C., Hinthorn, W., Xu, R., @Zeng, Q., Zeng, M., Huang, X., \textbf{Jiang, M.} ``Boosting Factual Correctness of Abstractive Summarization with Knowledge Graph'', under review at \textit{Conference on Empirical Methods in Natural Language Processing} (EMNLP), 2020.

\item[CR7] @Zeng, Q., @Yu, W., *Yu, M., @Jiang, T., Weninger, T., \textbf{Jiang, M.} ``Tri-Train: Automatic Pre-fine Tuning between Pre-training and Fine-tune Training for SciNER'', under review at \textit{Conference on Empirical Methods in Natural Language Processing} (EMNLP), 2020.

\item[CR6] @Zeng, Q., *Yu, M., @Yu, W., @Jiang, T., Weninger, T., \textbf{Jiang, M.} ``Validating Label Consistency in NER Data Annotation'', under review at \textit{Conference on Empirical Methods in Natural Language Processing} (EMNLP), 2020.

\item[CR5] Zhang, C., Yu, L., Saebi, M., \textbf{Jiang, M.}, Chawla, N.V. ``Few-Shot Multi-Hop Relation Reasoning over Knowledge Bases'', under review at \textit{Conference on Empirical Methods in Natural Language Processing} (EMNLP), 2020.

\item[CR4] *Alaphat, A., \textbf{Jiang, M.} ``SmartFund: Predicting Research Outcomes with Machine Learning and Natural Language Processing'', under review at \textit{IEEE International Conference on Data Science and Advanced Analytics} (DSAA), 2020.
	
\item[CR3] @Anuyah, O., @Douailly-Backman, J.-P., Metoyer, R., \textbf{Jiang, M.} ``Modeling User Behaviors to Predict HatefulnessLevel of Posts on Social Media'', under review at \textit{IEEE International Conference on Data Science and Advanced Analytics} (DSAA), 2020.

\item[CR2] Schnur, J., Karl, R., Martinez, A.G., \textbf{Jiang, M.}, Chawla, N.V. ``Imputing Common Growth Snapshots in Child Health Development: A Tensor Decomposition Approach'', under review at \textit{ACM International Conference on Information and Knowledge Management} (CIKM), 2020.
