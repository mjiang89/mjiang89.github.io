...
\fancypagestyle{firststyle}
{
   ...
   \fancyhead[R]{\vspace{-2cm}\footnotesize Last updated April 4, 2020}
}
...
\item[CR10] Saebi, M., Krieg, S., Zhang, C., \textbf{Jiang, M.}, Chawla, N.V. ``Heterogeneous Relational Reasoning in Knowledge Graphs with Reinforcement Learning'', under review at \textit{The European Conference on Machine Learning and Principles and Practice of Knowledge Discovery in Databases} (ECML-PKDD), 2020.

\item[CR9] Liu, Y., Lin, J., Zeng, Q., \textbf{Jiang, M.}, Cleland-Huang, J. ``Towards Semantically-Aware Traceability'', under review at \textit{IEEE International Requirements Engineering Conference} (RE), 2020.		

\item[CR8] @Wang, D., \textbf{Jiang, M.}, Syed, M., Conway, O., Juneja, V., Subramanian, S., Chawla, N.V. ``Calendar Graph Neural Networks for Modeling Time Structures in Spatiotemporal User Behaviors'', under review at \textit{ACM SIGKDD International Conference on Knowledge Discovery and Data Mining} (KDD), 2020.

\item[CR7] @Zhao, T., *Deng, C., *Yu, K., @Jiang, T., @Wang, D., \textbf{Jiang, M.} ``Error-bounded Graph Anomaly Loss for GNNs'', under review at \textit{ACM SIGKDD International Conference on Knowledge Discovery and Data Mining} (KDD), 2020.

\item[CR6] Zhang, C., Yao, H., Yu, L., Huang, C., Song, D., \textbf{Jiang, M.}, Chen, H., Chawla, N.V. ``Inductive Contextual Personalization'', under review at \textit{ACM SIGKDD International Conference on Knowledge Discovery and Data Mining} (KDD), 2020.

\item[CR5] Shi, X., Shang, J., \textbf{Jiang, M.}, Liu, L., Hanratty, T., Han, J. ``Contrast Subgraph Mining from Coherent Cores'', under review at \textit{ACM SIGKDD International Conference on Knowledge Discovery and Data Mining} (KDD), 2020.

\item[CR4] Jiang, T., Zhang, N., \textbf{Jiang, M.}, Liu, M., Qin, B., Liu, T. ``The Use of Internal Knowledge: Neural Biomedical Literature Search Liberated From External Resources'', under review at \textit{ACM SIGKDD International Conference on Knowledge Discovery and Data Mining} (KDD), 2020.

\item[CR3] Huang, C., Li, R., Zhang, C., \textbf{Jiang, M.}, Dai, P., Bo, L., Chawla, N.V. ``Multi-Grained Learning of Temporal Hierarchy for Time Series Forecasting'', under review at \textit{International Joint Conference on Artificial Intelligence} (IJCAI), 2020.
		
\item[CR2] @Jiang, T., @Zhao, T., Qin, B., Liu, T., Chawla, N.V., \textbf{Jiang, M.} ``Canonicalizing Open Knowledge Bases with Multi-layered Meta-graph Neural Network'', under review at \textit{International Joint Conference on Artificial Intelligence} (IJCAI), 2020.

\item[CR1] @Wang, D., @Zhao, T., @Jiang, T., Chawla, N.V., \textbf{Jiang, M.} ``EvoGNN: Modeling Co-evolution of Attributed and Structural Information in Dynamic Networks'', under review at \textit{International Joint Conference on Artificial Intelligence} (IJCAI), 2020.
