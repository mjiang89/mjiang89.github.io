...
\fancypagestyle{firststyle}
{
   ...
   \fancyhead[R]{\vspace{-2cm}\footnotesize Last updated August 22, 2020}
}
...
%\item[] @Yu, W., Wu, L., Deng, Y., Mahindru, R., @Zeng, Q., Guven, S., \textbf{Jiang, M.} ``Technical Question Answering across Tasks and Domains'', under review at \textit{???} (???), 2020.
