...
\fancypagestyle{firststyle}
{
   ...
   \fancyhead[R]{\vspace{-2cm}\footnotesize Last updated May 16, 2020}
}
...
%\begin{enumerate}[leftmargin=.5cm]
%
%\item[JR5] Liu, Z., \textbf{Jiang, M.}, Lin, H. ``A Graph-based Spatial Temporal Logic for Knowledge Representation and Automated Reasoning'' under review at \textit{Artificial Intelligence}. (IF=4.483)
%
