...
\fancypagestyle{firststyle}
{
   ...
   \fancyhead[R]{\vspace{-2cm}\footnotesize Last updated January 29, 2021}
}
...
\item[CR7] Huang, C., Li, R., Zhang, C., \textbf{Jiang, M.}, Dai, P., Bo, L., Chawla, N.V. ``Multi-Grained Learning of Temporal Hierarchy for Time Series Forecasting'', under review at \textit{the 30th International Joint Conference on Artificial Intelligence} (IJCAI), 2021.
		
\item[CR6] @Anuyah, O., @Douailly-Backman, J.-P., Metoyer, R., \textbf{Jiang, M.} ``Modeling User Behaviors to Predict Hatefulness Level of Posts on Gab'', under review at \textit{the 29th ACM Conference on User Modeling, Adaptation and Personalization} (UMAP), 2021.

\item[CR5] @Yu, W., Wu, L., @Zeng, Q., Deng, Y., Mahindru, R., Guven, S., \textbf{Jiang, M.} ``Technical Question Answering across Tasks and Domains'', under review at \textit{Conference of the North American Chapter of the Association for Computational Linguistics - Human Language Technologies} (NAACL-HLT), 2021.

\item[CR4] *Dong, X., @Yu, W., Zhu, C., \textbf{Jiang, M.} ``Enhancing Entity-Guided Text Generation with Entity Class Information'', under review at \textit{Conference of the North American Chapter of the Association for Computational Linguistics - Human Language Technologies} (NAACL-HLT), 2021.

\item[CR3] Zhu, C., Hinthorn, W., Xu, R., @Zeng, Q., Zeng, M., Huang, X., \textbf{Jiang, M.} ``Enhancing Factual Consistency of Abstractive Summarization'', under review at \textit{Conference of the North American Chapter of the Association for Computational Linguistics - Human Language Technologies} (NAACL-HLT), 2021.

\item[CR2] @Zeng, Q., *Yu, M., @Yu, W., @Jiang, T., Weninger, T., \textbf{Jiang, M.} ``Validating Label Consistency in NER Data Annotation'', under review at \textit{Conference of the North American Chapter of the Association for Computational Linguistics - Human Language Technologies} (NAACL-HLT), 2021.
