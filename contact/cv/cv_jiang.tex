...
\fancypagestyle{firststyle}
{
   ...
   \fancyhead[R]{\vspace{-2cm}\footnotesize Last updated June 4, 2021}
}
...
\hspace{-0.75cm} Total Amount: \$1,401,751; Total Share: \textbf{\$628,671}
...
\hspace{-0.25cm}\textit{Refereed Conference Papers} {\small (12 ACM SIGKDD full papers, etc.)}
...
\item[C56] @Yu, W., Wu, L., @Zeng, Q., Deng, Y., Mahindru, R., Guven, S., \textbf{Jiang, M.} ``Technical Question Answering across Tasks and Domains'', in Proceedings of \textit{Conference of the North American Chapter of the Association for Computational Linguistics - Human Language Technologies} (NAACL-HLT), 2021.
		
\item[C55] Zhu, C., Hinthorn, W., Xu, R., @Zeng, Q., Zeng, M., Huang, X., \textbf{Jiang, M.} ``Enhancing Factual Consistency of Abstractive Summarization'', in Proceedings of \textit{Conference of the North American Chapter of the Association for Computational Linguistics - Human Language Technologies} (NAACL-HLT), 2021.
...
\item[J23] @Wang, D., @Zeng, Q., Chawla, N.V., \textbf{Jiang, M.} ``Modeling Complementarity in Behavior Data with Multi-Type Itemset Embedding'', \textit{ACM Transactions on Intelligent Systems and Technology}. In press. (IF=2.861)
		
\item[J22] Zhang, C., Yao, H., Yu, L., Huang, C., Song, D., \textbf{Jiang, M.}, Chen, H., Chawla, N.V. ``Inductive Contextual Relation Learning for Personalization'', \textit{ACM Transactions on Information Systems}. In press. (IF=2.312)
...
\item[P25] @Yu, W., Zhu, C., @Zhao, T., Guo, Z., \textbf{Jiang, M.} ``Sentence-Permuted Paragraph Generation'', in \textit{arXiv preprint arXiv:2104.07228}, April 2021.
...
\item[P23] Guo, Z., Zhang, C., @Yu, W., Herr, J., Wiest, O., \textbf{Jiang, M.}, Chawla, N.V. ``Few-Shot Graph Learning for Molecular Property Prediction'', in \textit{arXiv preprint arXiv:2102.07916}, February 2021.

\item[P22] @Zeng, Q., @Yu, M., @Yu, W., Jiang, T., Weninger, T., \textbf{Jiang, M.} ``Validating Label Consistency in NER Data Annotation'', in \textit{arXiv preprint arXiv:2101.08698}, January 2021.

\item[P21] @Zhao, T., *Ni, B., @Yu, W., \textbf{Jiang, M.} ``Early Anomaly Detection by Learning and Forecasting Behavior'', in \textit{arXiv preprint arXiv:2010.10016}, October 2020.
...
\item[P18] *Dong, X., @Yu, W., Zhu, C., \textbf{Jiang, M.} ``Injecting Entity Types into Entity-Guided News Generation'', in \textit{arXiv preprint arXiv:2009.13401}, September 2020.
		
\item[P17] *Chou, D., \textbf{Jiang, M.} ``Data-Driven Network Intrusion Detection: A Taxonomy of Challenges and Methods'', in \textit{arXiv preprint arXiv:2009.07352}, September 2020.
...
\item[P13] @Zhao, T., Liu, Y., Neves, L., Woodford, O., \textbf{Jiang, M.}, Shah, N. ``Data Augmentation for Graph Neural Networks'' in \textit{arXiv preprint arXiv:2006.06830}, June 2020.
...
\item[P9] Zhu, C., Hinthorn, W., Xu, R., Zeng, @Q., Zeng, M., Huang, X., \textbf{Jiang, M.} ``Boosting Factual Correctness of Abstractive Summarization with Knowledge Graph'' in \textit{arXiv preprint arXiv:2003.08612}, March 2020.

\item[P8] Saebi, M., Krieg, S., Zhang, C., \textbf{Jiang, M.}, Chawla, N.V. ``Heterogeneous Relational Reasoning in Knowledge Graphs with Reinforcement Learning'' in \textit{arXiv preprint arXiv:2003.06050}, March 2020. (Mandana Saebi won the \textbf{first place} in ACM Student Research Competition -- Graduate Winners)
...
%\item[CR] @Yu, W., \textbf{Jiang, M.} ``A Structured Review of Multi-task Neural Training in NLP'', under review at \textit{} (), 2021.

%\item[CR] @Anuyah, O., @Douailly-Backman, J.-P., Metoyer, R., \textbf{Jiang, M.} ``Modeling User Behaviors to Predict Hatefulness Level of Posts on Gab'', under review at \textit{} (), 2021.

%\item[CR] Lu, Q., Jiang, W., Zhao, Z., \textbf{Jiang, M.}, Hu, J., Dasgupta, S., Shi, Y. ``Hardware/Software Co-Exploration for Graph Neural Architectures on FPGAs'', under review at \textit{} (), 2021.

%\item[CR] Huang, C., Li, R., Zhang, C., \textbf{Jiang, M.}, Dai, P., Bo, L., Chawla, N.V. ``Multi-Grained Learning of Temporal Hierarchy for Time Series Forecasting'', under review at \textit{} (), 2021.

\item[CR6] @Zhao, T., @Liu, G., @Wang, D., @Yu, W., \textbf{Jiang, M.} ``Counterfactual Graph Learning for Link Prediction'', under review at \textit{Conference on Neural Information Processing Systems} (NeurIPS), 2021.

\item[CR5] @Wang, D., @Zhao, T., Chawla, N.V., \textbf{Jiang, M.} ``Dynamic Attributed Graph Prediction with Conditional Normalizing Flows'', under review at the \textit{International Conference on Data Mining} (ICDM), 2021.

\item[CR4] @Zhao, T., *Ni, B., @Yu, W., Guo, Z., Shah, N., \textbf{Jiang, M.} ``Action Sequence Augmentation for Early Graph-based Anomaly Detection'', under review at \textit{ACM International Conference on Information and Knowledge Management} (CIKM), 2021.
	
\item[CR3] @Yu, W., Zhu, C., @Zhao, T., Guo, Z., \textbf{Jiang, M.} ``Sentence-Permuted Paragraph Generation'', under review at \textit{Conference on Empirical Methods in Natural Language Processing} (EMNLP), 2021.

\item[CR2] @Yu, W., Zhu, C., Qin, L., @Zhao, T. \textbf{Jiang, M.} ``Diverse Generative Reasoning on Commonsense Knowledge Graphs'', under review at \textit{Conference on Empirical Methods in Natural Language Processing} (EMNLP), 2021.

\item[CR1] *Dong, X., @Yu, W., Zhu, C., \textbf{Jiang, M.} ``Injecting Entity Types into Entity-Guided Text Generation'', under review at \textit{Conference on Empirical Methods in Natural Language Processing} (EMNLP), 2021.
...
\item[JR9] Gu, S., \textbf{Jiang, M.}, Guzzi, P.H., Milenkovic, T. ``Modeling Multi-scale Data via a Network of Networks'', under review at \textit{Bioinformatics}. (IF=5.610)

\item[JR8] @Wang, D., @Zhao, T., @Yu, W., Chawla, N.V., \textbf{Jiang, M.} ``Deep Multimodal Complementarity Learning'', under review at \textit{IEEE Transactions on Knowledge and Data Engineering}. (IF=4.935)

\item[JR7] Syed, M., Krieg, S.J., Wang, D., \textbf{Jiang, M.}, Conway, O., Juneja, V., Subramanian, S., Chawla, N.V. ``Overcoming Data Sparsity and Class Imbalance with Graph Embeddings'', under review at \textit{Social Network Analysis and Mining}.

\item[JR6] \textbf{Jiang, M.}, Jung, T., Karl, R., @Zhao, T. ``Federated Dynamic Graph Neural Networks with Secure Aggregation for Video-based Distributed Surveillance'', under review at \textit{ACM Transactions on Intelligent Systems and Technology}. (Special issue on Federated Learning, IF=2.861)

\item[JR5] @Yu, W., Zhu, C., *Li, Z., Hu, Z., Wang, Q., Ji, H., \textbf{Jiang, M.} ``A Survey of Knowledge-Enhanced Text Generation'', under review at \textit{ACM Computing Surveys}. (IF=6.131)

\item[JR4] @Wang, D., *Zhang, Z., *Ma, Y., @Zhao, T., @Jiang, T., Chawla, N.V., \textbf{Jiang, M.} ``Modeling Co-evolution of Attributed and Structural Information in Graph Sequence'', under review at \textit{IEEE Transactions on Knowledge and Data Engineering}. (Minor revision, IF=4.935)

\item[JR3] *Chou, D., \textbf{Jiang, M.} ``Data-Driven Network Intrusion Detection: A Taxonomy of Challenges and Methods'', under review at \textit{ACM Computing Surveys}. (Major revision, IF=6.131)
	
\item[JR2] Saebi, M., Krieg, S., Zhang, C., \textbf{Jiang, M.}, Kajdanowicz, T., Chawla, N.V. ``Heterogeneous Relational Reasoning in Knowledge Graphs with Reinforcement Learning'', under review at \textit{Transactions on Knowledge Discovery from Data}. (Major revision, IF=2.200)

\item[JR1] @Zhao, T., @Jiang, T., Shah, N., \textbf{Jiang, M.} ``A Synergistic Approach for Graph Anomaly Detection with Pattern Mining and Feature Learning'', under review at \textit{IEEE Transactions on Neural Networks and Learning Systems}. (Minor revision, IF=8.793)
...
% \item[WR] *Kuebler, J., @Tong, L., \textbf{Jiang, M.} ``Multi-Round Parsing-based Multiword Rules for Scientific OpenIE'', 2021.
		
\item[WR2] @Zeng, Q., Lin, J., Yu, W., Cleland-Huang, J., \textbf{Jiang, M.} ``Boosting Taxonomy Completion with Concept Generation'', under review at the \textit{International Workshop on Data Mining in Bioinformatics} (BIOKDD) in conjunction with \textit{ACM SIGKDD International Conference on Knowledge Discovery and Data Mining} (KDD), 2021.

\item[WR1] @Wang, D., @Zhao, T., Chawla, N.V., \textbf{Jiang, M.} ``Evolutionary Graph Normalizing Flows'', under review at the \textit{International Workshop on Deep Learning on Graphs: Methods and Applications} (DLG) in conjunction with \textit{ACM SIGKDD International Conference on Knowledge Discovery and Data Mining} (KDD), 2021.
...
\hspace{-0.75cm} ``The Role of Conditions in Scientific Knowledge Extraction'', NEC Laboratories Europe, Zoom, May 2021
...
\hspace{-0.75cm}{\bf Rebekah Fang} and {\bf Libby Garnett}, \textit{Trinity High School} (since August 2020) \\
