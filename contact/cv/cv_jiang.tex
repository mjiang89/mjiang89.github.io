...
\fancypagestyle{firststyle}
{
   ...
   \fancyhead[R]{\vspace{-2cm}\footnotesize Last updated September 4, 2020}
}
...
%\item[CR] @Zeng, Q., *Yu, M., @Yu, W., @Jiang, T., Weninger, T., \textbf{Jiang, M.} ``Validating Label Consistency in NER Data Annotation'', under review at \textit{} (), 2020.

%\item[CR] @Zhao, T., Liu, Y., Woodford, O., Neves, L., \textbf{Jiang, M.}, Shah, N. ``Improving Graph Neural Network Generalization with Data Augmentation'', under review at \textit{} (), 2020.
...
\item[CR19] Huang, C., Li, R., Zhang, C., \textbf{Jiang, M.}, Dai, P., Bo, L., Chawla, N.V. ``Multi-Grained Learning of Temporal Hierarchy for Time Series Forecasting'', under review at \textit{AAAI Conference on Artificial Intelligence} (AAAI), 2021.
		
\item[CR18] \textbf{Jiang, M.}, Jung, T., Karl, R., @Zhao, T. ``Federated Dynamic GNN with Secure Aggregation'', under review at \textit{AAAI Conference on Artificial Intelligence} (AAAI), 2021.
		
\item[CR17] @Zeng, Q., Lin, J., Yu, W., Cleland-Huang, J., \textbf{Jiang, M.} ``Generating Ontologies When Concepts Cannot Be Found in Corpus'', under review at \textit{AAAI Conference on Artificial Intelligence} (AAAI), 2021.

\item[CR16] Zhang, C., Yu, L., Saebi, M., Guo, Z., \textbf{Jiang, M.}, Chawla, N.V. ``Multi-Hop Meta Relation Learning for Knowledge Bases'', under review at \textit{AAAI Conference on Artificial Intelligence} (AAAI), 2021.

\item[CR15] @Yu, W., Wu, L., @Zeng, Q., Deng, Y., Mahindru, R., Guven, S., \textbf{Jiang, M.} ``Technical Question Answering across Tasks and Domains'', under review at \textit{AAAI Conference on Artificial Intelligence} (AAAI), 2021.	

\item[CR14] Guo, Z., Zhang, C., @Yu, W., Herr, J., Wiest, O., \textbf{Jiang, M.}, Chawla, N.V. ``Task-similarity Aware Meta-transfer Learning for Molecular Property Prediction'', under review at \textit{AAAI Conference on Artificial Intelligence} (AAAI), 2021.
