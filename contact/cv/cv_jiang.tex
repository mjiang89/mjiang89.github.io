...
{Google Scholar: \#citation = \textbf{1320}, H-index = \textbf{17}}
\begin{itemize}
...
Research topics on Computational Behavior Modeling
\vspace{0.03in}
\begin{itemize}
\item Content: Text data mining and information extraction		
\item Context: Spatiotemporal data mining and social media analysis
\item Intention: Graph anomaly detection
\item Decision making: Representation learning and predictive models
\end{itemize}
\vspace{-0.1in}
Applications on modeling human behaviors
\vspace{-0.12in}
\begin{multicols}{2}
\begin{itemize}
...
{Mr. Tianwen Jiang, Harbin Institute of Technology, PhD student, advised by Prof. Bing Qin} \\
{Ms. Jiahui Wang, Beijing Jiaotong University, Master student, advised by Prof. Peng Bao} \\
{Mr. Rui Liu, Dalian University of Technology, undergraduate student} \\
{Mr. Guoqiang Liu, Biology, University of Notre Dame, PhD student}
