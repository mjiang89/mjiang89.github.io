...
\textbf{Data-driven Behavioral Analytics} \\
$\bullet$ {Methodology:} from observation, representation to models and algorithms; \\
$\bullet$ {Applications:} behavior prediction, recommender systems, anti-fraud systems, etc. \\
...
\begin{itemize} \itemsep -2pt
	...
	\item Integrating networks for intelligent and trustworthy systems.
\end{itemize}
...
[T2] \textbf{Meng Jiang}, Peng Cui and Jiawei Han. ``Data-Driven Behavioral Analytics: Observations, Representations and Models'', in ACM International Conference on Information and Knowledge Management (CIKM), 2016. (Taught 2.5 of 3.5 hours)
