...
{Google Scholar: \#citation = \textbf{1084}}
\begin{itemize}
...
\item Intention: Anomaly detection and actionable objective optimization
\end{itemize}
\vspace{-0.1in}
...
%----------------------------------------------------------------------------------------
%	PAPERS IN REVIEW SECTION
%----------------------------------------------------------------------------------------

%\section{Manuscripts in Review}

%[M6] Kun Kuang, Peng Cui, Bo Li, \textbf{Meng Jiang} and Shiqiang Yang. ``Treatment Effect Estimation via Differentiated Confounder Balancing and Regression'', submitted to IEEE Transactions on Knowledge and Data Engineering (\textbf{TKDE}).

%[M5] Xueying Wang${}^{+}$, Qi Li and \textbf{Meng Jiang}. ``On Power of the World’s Invariants: When Truth Finding Meets Temporal Unstructured Data'', in review. (${}^{+}$ for advisees)

%[M4] Jingbo Shang, Xiyao Shi, \textbf{Meng Jiang}, Liyuan Liu, Timothy Hanratty and Jiawei Han. ``Contrast Subgraph Mining from Coherent Cores'', in review.

%[M3] Fangbo Tao, Chao Zhang, Xiusi Chen, \textbf{Meng Jiang}, Tim Hanratty, Lance Kaplan and Jiawei Han. ``Doc2Cube: Automated Document Allocation to Text Cube via Dimension-Aware Joint Embedding'', in review.
...
{Daheng Wang, PhD student (2016--), coadvised with Prof. Nitesh Chawla} \\
{Haiqiao Zhang, PhD student (2016--), coadvised with Prof. Yiyu Shi} \\
...
\item ACM International Conference on Information and Knowledge Management (\textbf{CIKM}), 2017, 2018
\item ACM International Conference on Multimedia (\textbf{MM}), 2017, 2018
\item AAAI Conference on Artificial Intelligence (\textbf{AAAI}), 2017, 2018
\item Pacific-Asia Conference on Knowledge Discovery and Data Mining (\textbf{PAKDD}), 2017, 2018
...
\item ACM International Conference on Web Search and Data Mining (\textbf{WSDM}), 2018
\item International World Wide Web Conference (\textbf{WWW}), 2018
\item IEEE International Conference on Data Science in Cyberspace (\textbf{DSC}), 2018
