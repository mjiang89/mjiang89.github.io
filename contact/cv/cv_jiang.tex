...
\fancypagestyle{firststyle}
{
   ...
   \fancyhead[R]{\vspace{-2cm}\footnotesize Last updated June 21, 2019}
}
...
\item[CR8] @Ding, Y., @Wang, D., Jiang, M. ``Preserving Composition and Crystal Structure Information of Chemical Compounds in Atomic Embedding'', under review at ACM International Conference on Information and Knowledge Management (CIKM), 2019.
