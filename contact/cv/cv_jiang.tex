...
\fancypagestyle{firststyle}
{
   ...
   \fancyhead[R]{\vspace{-2cm}\footnotesize Last updated June 17, 2019}
}
...
\item[CR9] *Yu, W., *Shu, Y., @Zeng, Q., Jiang, M. ``Experimental Evidence Extraction in Data Science with Hybrid Table Features and Ensemble Learning'', under review at ACM International Conference on Information and Knowledge Management (CIKM), 2019.

\item[CR8] @Ding, Y., @Wang, D., Jiang, M. ``Preserving Composition and Crystal Structures of Chemical Compounds in Atomic Embedding'', under review at ACM International Conference on Information and Knowledge Management (CIKM), 2019.
