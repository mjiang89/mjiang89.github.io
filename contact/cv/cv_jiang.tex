...
\hspace{-0.25cm}\emph{Refereed Conference Papers} (9 ACM SIGKDD research track, etc.)
...
\hspace{-0.25cm}\emph{Refereed Journal Papers} (6 IEEE Transactions on Knowledge and Data Engineering (TKDE), etc.)
