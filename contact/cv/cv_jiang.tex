...
\fancypagestyle{firststyle}
{
   ...
   \fancyhead[R]{\vspace{-2cm}\footnotesize Last updated May 23, 2020}
}
...
\item[J18] \textbf{Jiang, M.}, Ammerman, B.A., @Zeng, Q., Jacobucci, R., Brodersen, A. ``Phrase-level Pairwise Topic Modeling to Uncover Helpful Peer Responses to Online Suicidal Crises'' \textit{Humanities \& Social Sciences Communications} (formerly known as \textit{Nature Palgrave Communications}). To appear, accepted May 2020.
...
%\vspace{-0.4cm} \line(1,0){370} \vspace{-0.1cm}
%
%%\item[CR] Zhang, C., Yao, H., Yu, L., Huang, C., Song, D., \textbf{Jiang, M.}, Chen, H., Chawla, N.V. ``Inductive Contextual Personalization'', under review at \textit{} (), 2020.
%%
...
%\begin{enumerate}[leftmargin=.5cm]
%
%\item[JR4] Liu, Z., \textbf{Jiang, M.}, Lin, H. ``A Graph-based Spatial Temporal Logic for Knowledge Representation and Automated Reasoning'' under review at \textit{Artificial Intelligence}. (IF=4.483)
%
