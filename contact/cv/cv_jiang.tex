...
\item[CR5] @Anuyah, O., @Douailly-Backman, J.-P., Metoyer, R., \textbf{Jiang, M.} ``Modeling User Behaviors to Predict Hatefulness Level of Posts on Gab'', under review at \textit{the 29th ACM Conference on User Modeling, Adaptation and Personalization} (UMAP), 2021.		
