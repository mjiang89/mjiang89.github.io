...
\fancypagestyle{firststyle}
{
   ...
   \fancyhead[R]{\vspace{-2cm}\footnotesize Last updated January 11, 2020}
}
...
\item[C38] @Yu, W., *Yu, M., @Zhao, T., \textbf{Jiang, M.} ``Identifying Referential Intention with Heterogeneous Contexts'', in Proceedings of \textit{The Web Conference} (TheWebConf), 2020. (acceptance rate 19\%)

\item[C37] @Yu, W., *Peng, W., *Shu, Y., @Zeng, Q., \textbf{Jiang, M.} ``Experimental Evidence Extraction in Data Science with Hybrid Table Features and Ensemble Learning'', in Proceedings of \textit{The Web Conference} (TheWebConf), 2020. (acceptance rate 19\%)
...
%\item[CRx] Syed, M., @Wang, D., \textbf{Jiang, M.}, Chawla, N.V. ``Predicting User Demographics from Online Consumption Behavior using Network Representation'', under review at \textit{XXX}, 2020.
		
%\item[CRx] @Wang, D., \textbf{Jiang, M.}, Chawla, N.V. ``Calendar Graph Neural Networks for Modeling Time Structures in Spatiotemporal User Behaviors'', under review at \textit{XXX}, 2020.

%\item[CRx] *Zhou, Y., @Zhao, T., \textbf{Jiang, M.} ``A Probabilistic Model with Commonsense Constraints for Pattern-based Temporal Fact Extraction'', under review at \textit{XXX}, 2020.
