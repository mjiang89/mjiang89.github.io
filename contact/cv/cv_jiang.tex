...
\fancypagestyle{firststyle}
{
   ...
   \fancyhead[R]{\vspace{-2cm}\footnotesize Last updated November 8, 2022}
}
...
\item[C73] @Zhang, Z., @Yu, W., Zhu, C., \textbf{Jiang, M.} ``A Unified Encoder-Decoder Framework with Entity Memory'', in Proceedings of \textit{Conference on Empirical Methods in Natural Language Processing} (EMNLP), 2022. (Oral presentation)

\item[C72] @Yu, W., Zhu, C., @Zhang, Z., Wang, S., Zhang, Z., Fang, Y., \textbf{Jiang, M.} ``Retrieval Augmentation for Commonsense Reasoning: A Unified Approach'', in Proceedings of \textit{Conference on Empirical Methods in Natural Language Processing} (EMNLP), 2022.
...
\hspace{-0.25cm}\textit{Manuscripts Under Review}

\begin{enumerate}[leftmargin=.5cm]

\item[R4] @Yu, W., Iter, D., Wang, S., Xu, Y., Ju, M., Sanyal, S., Zhu, C., Zeng, M., \textbf{Jiang, M.} ``Generate rather than Retrieve: Large Language Models are Strong Context Generators'', under review at \textit{International Conference on Learning Representations} (ICLR), 2023.

\item[R3] @Liu, G., @Zhao, T., @Inae, E., Luo, T., \textbf{Jiang, M.} ``Semi-Supervised Graph Imbalanced Regression'' under review at \textit{AAAI Conference on Artificial Intelligence} (AAAI), 2023.

\item[R2] Wu, X., Han, Y., Dahrouj, H., Bao, H., Liang, Z., Shihada, B., \textbf{Jiang, M.}, Zhang, X. ``Manipulating Predictions over Categorical Inputs via Iterative Machine Teaching'' under review at \textit{AAAI Conference on Artificial Intelligence} (AAAI), 2023.

\item[R1] \textbf{Jiang, M.} ``Transfer Learning across Graph Convolutional Networks: Methods, Theory, and Applications'' under review at ACM Transactions on Knowledge Discovery from Data.
...
\item[P36] @Yu, W., Iter, D., Wang, S., Xu, Y., Ju, M., Sanyal, S., Zhu, C., Zeng, M., \textbf{Jiang, M.} ``Generate rather than Retrieve: Large Language Models are Strong Context Generators'', in \textit{arXiv preprint arXiv:2209.10063}, September 2022.

\item[P35] @Hu, Z., \textbf{Jiang, M.} ``Heterogeneous Line Graph Transformer for Math Word Problems'', in \textit{arXiv preprint arXiv:2208.05645}, August 2022.
	
\item[P34] @Liu, G., @Zhang, Z., Ning, Z., \textbf{Jiang, M.} ``On the Relationship between Counterfactual Explainer and Recommender: A Framework and Preliminary Observations'', in \textit{arXiv preprint arXiv:2207.04317}, July 2022. (accepted in DS4RRS 2022)
...
\hspace{-0.75cm} Lecture for Research Experiences for Teachers (RET) in Engineering and Computer Science, 131 DBRT, Notre Dame, July 2022
...
%\hspace{-0.75cm} University of Science and Technology of China, Zoom, August 2022
...
\hspace{-0.75cm}{\bf Yunxiang (Ryan) Yan}, \textit{Visiting Undergraduate Student} (September 2021--August 2022)
...
\hspace{-0.75cm}{\bf William Porter}, \textit{Undergraduate Student} (since July 2022)
...
\hspace{-0.75cm}{\bf CSE 60326 Computational Behavior Modeling}, \textit{University of Notre Dame} (Spring 2023)
...
\textcolor{white}{} Social media committee at ND CSE (since 2022)
}
...
\hspace{-0.75cm}NeurIPS 2022 GLFrontiers Workshop: \\
(AC: 2022)
