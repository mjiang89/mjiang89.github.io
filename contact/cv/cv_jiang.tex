...
\fancypagestyle{firststyle}
{
   ...
   \fancyhead[R]{\vspace{-2cm}\footnotesize Last updated January 15, 2020}
}
...
\item[CR7] @Jiang, T., @Zhao, T., Qin, B., Liu, T., Chawla, N.V., \textbf{Jiang, M.} ``Canonicalizing Open Knowledge Bases with Multi-layered Meta-graph Neural Network'', under review at \textit{International Joint Conference on Artificial Intelligence} (IJCAI), 2020.

\item[CR6] @Wang, D., @Zhao, T., @Jiang, T., Chawla, N.V., \textbf{Jiang, M.} ``EvoGNN: Modeling Co-evolution of Attributed and Structural Information in Dynamic Networks'', under review at \textit{International Joint Conference on Artificial Intelligence} (IJCAI), 2020.
