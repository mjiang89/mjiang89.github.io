...
\item[CR12] *Dong, X., @Yu, W., Zhu, C., \textbf{Jiang, M.} ``Entity-Guided News Generation with Mention Pointer Network'', under review at \textit{Conference on Empirical Methods in Natural Language Processing} (EMNLP), 2020.
