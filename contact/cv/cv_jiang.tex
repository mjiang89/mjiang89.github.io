...
\fancypagestyle{firststyle}
{
   ...
   \fancyhead[R]{\vspace{-2cm}\footnotesize Last updated July 14, 2022}
}
...
\item[W21] @Liu, G., @Zhang, Z., Ning, Z., \textbf{Jiang, M.} ``On the Relationship between Counterfactual Explainer and Recommender: A Framework and Preliminary Observations'', in the \textit{Workshop on Data Science and Artificial Intelligence for Responsible Recommendations} (DS4RRS) at \textit{ACM SIGKDD International Conference on Knowledge Discovery and Data Mining} (KDD), 2022.
...
\item[W17] @Liu, G., @Zhang, Z., Ning, Z., \textbf{Jiang, M.} ``On the Relationship between Counterfactual Explainer and Recommender: A Framework and Preliminary Observations'', in the \textit{First Workshop on Data Science and Artificial Intelligence on Responsible Recommendation} (DSAI4RRS) in conjunction with \textit{ACM SIGKDD International Conference on Knowledge Discovery and Data Mining} (KDD), 2022.
...
%\item[CR] @Hu, Z., \textbf{Jiang, M.} ``Solving Math Word Problems Automatically with Heterogeneous Line Graph Transformer for Online Learning'', under review at \textit{} ().

%\item[CR] @Zhao, T., Tang, X., Zhang, D., Rao, N., Song, Y., Agrawal, P., Subbian, K., Yin, B., \textbf{Jiang, M.} ``AutoGDA: Automated Graph Data Augmentation for Node Classification'', under review at \textit{} ().
...
%\item[CR] Wu, Z., \textbf{Jiang, M.}, Shen, C. ``Learning Multivariable Logic Rules on Knowledge Graphs'', under review at \textit{} ().
...
%\item[JR2] Liu, Z., \textbf{Jiang, M.}, Luo, T. ``Leveraging Low-Fidelity Data to Improve Machine Learning of Sparse High-Fidelity Thermal Conductivity Data via Transfer Learning'', under review at \textit{}. (IF=)
...
\hspace{-0.75cm}{\bf Qi Liu}, \textit{Visiting Undergraduate Student} (since July 2022)

\hspace{-0.75cm}{\bf Xuan Zhang}, \textit{Virtually Visiting Undergraduate Student} (since July 2022)

\hspace{-0.75cm}{\bf Dong Liu}, \textit{Virtually Visiting Undergraduate Student} (since July 2022)

\hspace{-0.75cm}{\bf Yuchen Li}, \textit{Virtually Visiting Undergraduate Student} (since July 2022)
