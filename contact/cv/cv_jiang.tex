...
\fancypagestyle{firststyle}
{
   ...
   \fancyhead[R]{\vspace{-2cm}\footnotesize Last updated September 19, 2020}
}
...
%\item[CR] @Zeng, Q., *Yu, M., @Yu, W., @Jiang, T., Weninger, T., \textbf{Jiang, M.} ``Validating Label Consistency in NER Data Annotation'', under review at \textit{} (), 2021.

%\item[CR] @Zeng, Q., Lin, J., Yu, W., Cleland-Huang, J., \textbf{Jiang, M.} ``Generating Ontologies When Concepts Cannot Be Found in Corpus'', under review at \textit{} (), 2021.

%\item[CR] Lu, Q., Jiang, W., Zhao, Z., \textbf{Jiang, M.}, Hu, J., Dasgupta, S., Shi, Y. ``Hardware and Neural Architecture Joint Search for Graph Neural Networks'', under review at \textit{} (), 2021.
