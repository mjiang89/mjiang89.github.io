...
\fancypagestyle{firststyle}
{
   ...
   \fancyhead[R]{\vspace{-2cm}\footnotesize Last updated February 1, 2021}
}
...
%\item[JR] \textbf{Jiang, M.}, @Yu, W., @Yu, M. ``Multi-task Encoder-Decoders Training in NLP Tasks: A Review'', under review at \textit{}.
		
\item[JR8] \textbf{Jiang, M.}, Jung, T., Karl, R., @Zhao, T. ``Federated Dynamic Graph Neural Networks with Secure Aggregation for Video-based Distributed Surveillance'', under review at \textit{ACM Transactions on Intelligent Systems and Technology}. (Special issue on Federated Learning, IF=2.861)

\item[JR7] @Zhao, T., @Jiang, T., Shah, N., \textbf{Jiang, M.} ``A Synergistic Approach for Graph Anomaly Detection with Pattern Mining and Feature Learning'', under review at \textit{IEEE Transactions on Neural Networks and Learning Systems}. (IF=8.793)

\item[JR6] @Yu, W., Zhu, C., *Li, Z., Hu, Z., Wang, Q., Ji, H., \textbf{Jiang, M.} ``A Survey of Knowledge-Enhanced Text Generation'', under review at \textit{ACM Computing Surveys}. (IF=6.131)
