...
\fancypagestyle{firststyle}
{
   ...
   \fancyhead[R]{\vspace{-2cm}\footnotesize Last updated February 24, 2022}
}
...
\bf{Postdoctoral Research Associate}&2015 -- 2017\\
 \multicolumn{2}{l}{~{Main Site: (Advisor: Prof. Jiawei Han)}}\\
 \multicolumn{2}{l}{~{- University of Illinois at Urbana-Champaign}}\\
 \multicolumn{2}{l}{~{- Department of Computer Science}} \\
 \multicolumn{2}{l}{~{Secondary Site: (Advisor: Prof. VS Subrahmanian)}}\\	
 \multicolumn{2}{l}{~{- University of Maryland}}\\
 \multicolumn{2}{l}{~{- Institute for Advanced Computer Studies}}
\end{tabular*}
\end{table}
\vspace{-0.4cm}
...
\bf{Ph.D.}&Tsinghua University, Computer Science&2015\\
 ...
 &\multicolumn{2}{l}{\small Graduated with honors (Advisor: Prof. Shiqiang Yang)}\\
 &\multicolumn{2}{l}{\small Visiting researcher at CMU (Advisor: Prof. Christos Faloutsos)}\\
...
\hspace{-0.75cm}External fund: Total amount: \$2,738,333; Total credit: \textbf{\$1,310,735}
...
Funding Vehicle: Notre Dame International \\
Amount: \textbf{\$8,400} \\
Role: {Sole PI}
...
Funding Vehicle: Notre Dame International (\emph{Completed}) \\
Amount: \$43,811 (ND Research) (Credit: 75\%; \textbf{\$33,281}) \\
Role: {ND CSE Lead PI}
...
\item[C65] @Yu, W., Zhu, C., Qin, L., @Zhao, T. \textbf{Jiang, M.} ``Diverse Generative Reasoning on Commonsense Knowledge Graphs'', in Findings of \textit{Annual Meeting of the Association for Computational Linguistics} (ACL), 2022.
...
\item[C61] @Yu, W., Zhu, C., @Zhao, T., Guo, Z., \textbf{Jiang, M.} ``Sentence-Permuted Paragraph Generation'', in Proceedings of \textit{Conference on Empirical Methods in Natural Language Processing} (EMNLP), 2021. (Long, Poster; acceptance rate 25.6\% = 650/2540)

\item[C60] *Dong, X., @Yu, W., Zhu, C., \textbf{Jiang, M.} ``Injecting Entity Types into Entity-Guided Text Generation'', in Proceedings of \textit{Conference on Empirical Methods in Natural Language Processing} (EMNLP), 2021. (Short, Oral; acceptance rate 6.2\% = 66/1060)
...
\item[J29] @Yu, W., Zhu, C., *Li, Z., Hu, Z., Wang, Q., Ji, H., \textbf{Jiang, M.} ``A Survey of Knowledge-Enhanced Text Generation'', \textit{ACM Computing Surveys}. In press. (IF=10.282)
		
\item[J28] \textbf{Jiang, M.}, Jung, T., Karl, R., @Zhao, T. ``Federated Dynamic Graph Neural Networks with Secure Aggregation for Video-based Distributed Surveillance'', \textit{ACM Transactions on Intelligent Systems and Technology}. In press. (IF=2.861)

\item[J27] *Chou, D., \textbf{Jiang, M.} ``A Survey on Data-Driven Network Intrusion Detection'', \textit{ACM Computing Surveys}. 54:9, 1-36, December 2022. (IF=10.282)

\item[J26] @Zhao, T., @Jiang, T., Shah, N., \textbf{Jiang, M.} ``A Synergistic Approach for Graph Anomaly Detection with Pattern Mining and Feature Learning'', \textit{IEEE Transactions on Neural Networks and Learning Systems}. Early access. (IF=8.793)
	
\item[J25] @Wang, D., *Zhang, Z., *Ma, Y., @Zhao, T., @Jiang, T., Chawla, N.V., \textbf{Jiang, M.} ``Modeling Co-evolution of Attributed and Structural Information in Graph Sequence'', \textit{IEEE Transactions on Knowledge and Data Engineering}. Early access. (IF=6.977)

\item[J24] Zhao, S., \textbf{Jiang, M.}, Qin, B., Liu, T., Zhai, C.X., Wang, F. ``Structural and Textual Information Fusion for Symptom and Disease Representation Learning'', \textit{IEEE Transactions on Knowledge and Data Engineering}. Early access. (IF=6.977)
...
\item[J10] Shang, J., Liu, J., \textbf{Jiang, M.}, Ren, X., Voss, C.R., Han, J. ``Automated Phrase Mining from Massive Text Corpora'' \textit{IEEE Transactions on Knowledge and Data Engineering}. 30:10, 1825-1837, October 2018. (IF=6.977)

\item[J9] Shang, J., \textbf{Jiang, M.}, Tong, W., Xiao, J., Peng, J., Han, J. ``DPPred: An Effective Prediction Framework with Concise Discriminative Patterns'' \textit{IEEE Transactions on Knowledge and Data Engineering}. 30:7, 1226-1239, July 2018. (IF=6.977)

\item[J8] Gui, H., Liu, J., Tao, F., \textbf{Jiang, M.}, Norick, B., Kaplan, L., Han, J. ``Embedding Learning with Events in Heterogeneous Information Networks'' \textit{IEEE Transactions on Knowledge and Data Engineering}. 29:11, 2428-2441, July 2017. (IF=6.977)
...
\item[J5] \textbf{Jiang, M.}, Beutel, A., Cui, P., Hooi, B., Yang, S., Faloutsos, C. ``Spotting Suspicious Behaviors in Multimodal Data: A General Metric and Algorithms'' \textit{IEEE Transactions on Knowledge and Data Engineering}. 28:8, 2187-2200, April 2016. (IF=6.977)
...
\item[J3] \textbf{Jiang, M.}, Cui, P., Chen, X., Wang, F., Zhu, W., Yang, S. ``Social Recommendation with Cross-Domain Transferable Knowledge'' \textit{IEEE Transactions on Knowledge and Data Engineering}. 27:11, 3084-3097, November 2015. (IF=6.977)

\item[J2] \textbf{Jiang, M.}, Cui, P., Wang, F., Zhu, W., Yang, S. ``Scalable Recommendation with Social Contextual Information'' \textit{IEEE Transactions on Knowledge and Data Engineering}. 26:11, 2789-2802, November 2014. (IF=6.977)
...
\item[P26] Gu, S., \textbf{Jiang, M.}, Guzzi, P.H., Milenkovic, T. ``Modeling Multi-scale Data via a Network of Networks'', in \textit{arXiv preprint arXiv:2105.12226}, May 2021.
...
%\item[CR] @Zhao, T., @Liu, G., Günnemann, S., \textbf{Jiang, M.} ``Graph Data Augmentation for Graph Machine Learning: A Survey'', under review at \textit{International Joint Conference on Artificial Intelligence} (IJCAI), 2022.

%\item[CR] @Zhao, T., Tang, X., Zhang, D., Rao, N., Song, Y., Agrawal, P., Subbian, K., Yin, B., \textbf{Jiang, M.} ``AutoGDA: Automated Graph Data Augmentation for Node Classification'', under review at \textit{ACM SIGKDD International Conference on Knowledge Discovery and Data Mining} (KDD), 2022.

%\item[CR] @Liu, G., @Zhao, T., Xu, J., Luo, T., \textbf{Jiang, M.} ``Graph Rationalization with Environment-based Augmentations'', under review at \textit{ACM SIGKDD International Conference on Knowledge Discovery and Data Mining} (KDD), 2022.

%\item[CR] @Hu, Z., \textbf{Jiang, M.} ``Solving Math Word Problems Automatically with Heterogeneous Line Graph Transformer for Online Learning'', under review at \textit{ACM SIGKDD International Conference on Knowledge Discovery and Data Mining} (KDD), 2022.

%\item[CR] Guo, X., @Zeng, Q., \textbf{Jiang, M.}, Yun, X., Long, B., Wu, L. ``Automatic Controllable Product Copywriting for E-Commerce'', under review at \textit{ACM SIGKDD International Conference on Knowledge Discovery and Data Mining} (KDD), 2022.

%\item[CR] @Zhao, T., @Liu, G., @Wang, D., @Yu, W., \textbf{Jiang, M.} ``Learning from Counterfactual Graph for Link Prediction'', under review at \textit{International Conference on Machine Learning} (ICML), 2022.
...
%\item[JR] @Zhang, Z., @Yu, W., \textbf{Jiang, M.} ``Recent Advances of Multi-task Learning in NLP: Regarding Task Relatedness and Training Methods'', under review at \textit{ARR Rolling Review February 2022}.

%\item[JR] @Wang, D., @Zhao, T., @Yu, W., Chawla, N.V., \textbf{Jiang, M.} ``Deep Multimodal Complementarity Learning'', under review at \textit{IEEE Transactions on Neural Networks and Learning Systems}. (Major revision)
	
%\item[JR] Gu, S., \textbf{Jiang, M.}, Guzzi, P.H., Milenkovic, T. ``Modeling Multi-scale Data via a Network of Networks'', under review at \textit{Bioinformatics}. (Major revision)
...
\hspace{-0.75cm} Keynote speech at ACM WSDM'22 Workshop Machine Learning on Graphs (MLoG), Phoenix, Arizona, February 2022
	
\hspace{-0.75cm} Keynote speech at IEEE/WIC/ACM WI-IAT'21 Special Track on Social Computing, Zoom, December 2021

\hspace{-0.75cm} Harbin Institute of Technology, Zoom, November 2021
	
\hspace{-0.75cm} Madison STEAM Academy (3rd, 4th, and 5th graders), October 2021
...
\hspace{-0.75cm}{\bf Daheng Wang}, \textit{Graduated July 2021} \\
	{Thesis: \textit{Learning Complementarity and Dynamics for Behavior Modeling}} \\
...
\hspace{-0.75cm}{\bf Daheng Wang}, \textit{PhD Student} (August 2017--June 2021)
...
\hspace{-0.75cm}{\bf Jackson Ballow}, \textit{Undergraduate Student} (since September 2021)
...
\hspace{-0.75cm}{\bf Ryan Pairitz}, \textit{Undergraduate Student} (since January 2022)

\hspace{-0.75cm}{\bf Kekoa Wang}, \textit{Undergraduate Student} (since January 2022)
...
\hspace{-0.75cm}{\bf Qingkai Zeng}, \textit{Ph.D. Candidate} (since January 2018) \\
	Proposal thesis: \textit{Improving Scientific Information Extraction with Text Generation}
...
\hspace{-0.75cm}\textit{2017--2022} \\
\textcolor{white}{.}AAAI Conference on Artificial Intelligence (AAAI) \\
\textcolor{white}{.}ACM International Conference on Knowledge Management (CIKM)

\hspace{-0.75cm}\textit{2018--2021} \\
\textcolor{white}{.}ACM SIGKDD Int'l Conf. on Knowledge Discovery and Data Mining (KDD) \\
\textcolor{white}{.}The Web Conference (WebConf/WWW) \\
\textcolor{white}{.}Conference on Empirical Methods in Natural Language Processing (EMNLP) \\
\textcolor{white}{.}SIAM Conference on Data Mining (SDM)

\hspace{-0.75cm}\textit{2019--2021} \\
\textcolor{white}{.}International Conference on Web Search and Data Mining (WSDM)

\hspace{-0.75cm}\textit{2020--2021} \\
...
\textcolor{white}{.}International Conference on Learning Representations (ICLR)
