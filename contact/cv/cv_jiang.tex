...
\hspace{-0.25cm}\emph{Refereed Conference Papers} {\small (10 ACM SIGKDD full papers, etc.)}

\begin{enumerate}[leftmargin=.5cm]

\item[C41] @Wang, D., \textbf{Jiang, M.}, Syed, M., Conway, O., Juneja, V., Subramanian, S., Chawla, N.V. ``Calendar Graph Neural Networks for Modeling Time Structures in Spatiotemporal User Behaviors'', in Proceedings of \emph{ACM SIGKDD International Conference on Knowledge Discovery and Data Mining} (KDD), August 2020. (applied data science track with oral presentation, acceptance rate 5.8\%=44/756)
...
\item[C29] @Wang, D., @Jiang, T., Chawla, N.V., \textbf{Jiang, M.} ``TUBE: Embedding Behavior Outcomes for Predicting Success'' in Proceedings of \emph{ACM SIGKDD International Conference on Knowledge Discovery and Data Mining} (KDD), August 2019. (research track with oral presentation, acceptance rate 9.2\%=110/1200; \textbf{won the Best Paper Award} at the Annual Meeting of the International Society for Data Science and Analytics (ISDSA), winning rate 6.9\%=2/29)
...
%\item[CR] Shi, X., Shang, J., \textbf{Jiang, M.}, Liu, L., Hanratty, T., Han, J. ``Contrast Subgraph Mining from Coherent Cores'', under review at \textit{} (), 2020.
%
%\item[CR] Jiang, T., Zhang, N., \textbf{Jiang, M.}, Liu, M., Qin, B., Liu, T. ``The Use of Internal Knowledge: Neural Biomedical Literature Search Liberated From External Resources'', under review at \textit{} (), 2020.
%
...
%
%\item[CR] Liu, Y., Lin, J., Zeng, Q., \textbf{Jiang, M.}, Cleland-Huang, J. ``Towards Semantically-Aware Traceability'', under review at \textit{} (), 2020.		
%
%\item[WR] *Dong, X., @Yu, W., \textbf{Jiang, M.} ``Investigating News Generation Performance at Different Levels of Entity Representations: Mentions, Names, and Types'', under review at \textit{} (), 2020.
...
\vspace{.2cm}\hspace{-0.25cm}\emph{Refereed Journal Papers}
...
\hspace{-0.75cm}\emph{2021}\textcolor{white}{.}International Conference on Web Search and Data Mining (WSDM)
