...
\fancypagestyle{firststyle}
{
   ...
   \fancyhead[R]{\vspace{-2cm}\footnotesize Last updated October 15, 2019}
}
...
%\item[CRx] @Zhao, T., *Deng, C., *Yu, K., @Jiang, T., @Wang, D., \textbf{Jiang, M.} ``Learning with Bipartite Graph Anomaly Losses'', under review at \textit{ACM SIGKDD International Conference on Knowledge Discovery and Data Mining} (KDD), 2020.

%\item[CRx] @Zeng, Q., *Yu, M., *Peng, W., @Jiang, T., Weninger, T., \textbf{Jiang, M.} ``Handling the Variety of Distant Labeling Methods for Recognizing Scientific Concepts'', under review at \textit{Annual meeting of the Association for Computational Linguistics} (ACL), 2020.
