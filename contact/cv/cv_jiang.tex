...
\item[CR20] \textbf{Jiang, M.}, Jung, T., Karl, R., @Zhao, T. ``Federated Dynamic GNN with Secure Aggregation'', under review at \textit{AAAI Conference on Artificial Intelligence} (AAAI), 2021.
		
\item[CR19] @Zeng, Q., Lin, J., Yu, W., Cleland-Huang, J., \textbf{Jiang, M.} ``Generating Ontologies When Concepts Cannot Be Found in Corpus'', under review at \textit{AAAI Conference on Artificial Intelligence} (AAAI), 2021.
...
\item[CR17] Zhang, C., Yu, L., Saebi, M., Guo, Z., \textbf{Jiang, M.}, Chawla, N.V. ``Multi-Hop Meta Relation Learning for Knowledge Bases'', under review at \textit{AAAI Conference on Artificial Intelligence} (AAAI), 2021.

\item[CR16] Lu, Q., Jiang, W., Zhao, Z., \textbf{Jiang, M.}, Hu, J., Dasgupta, S., Shi, Y. ``Hardware and Neural Architecture Joint Search for Graph Neural Networks'', under review at \textit{AAAI Conference on Artificial Intelligence} (AAAI), 2021.
