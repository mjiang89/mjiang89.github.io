...
\fancypagestyle{firststyle}
{
   ...
   \fancyhead[R]{\vspace{-2cm}\footnotesize Last updated September 29, 2019}
}
...
\item[JR2] @Wang, X., \textbf{Jiang, M.} ``Precise Temporal Slot Filling via Truth Finding with Data-Driven Commonsense'' under review at \textit{Knowledge and Information Systems}. (Major revision, IF=2.247)
