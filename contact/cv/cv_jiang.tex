...
\fancypagestyle{firststyle}
{
   ...
   \fancyhead[R]{\vspace{-2cm}\footnotesize Last updated July 31, 2021}
}
...
\item[J27] @Zhao, T., @Jiang, T., Shah, N., \textbf{Jiang, M.} ``A Synergistic Approach for Graph Anomaly Detection with Pattern Mining and Feature Learning'', \textit{IEEE Transactions on Neural Networks and Learning Systems}. In press. (IF=10.451)
		
\item[J26] Syed, M., @Wang, D., \textbf{Jiang, M.}, Conway, O., Juneja, V., Subramanian, S., Chawla, N.V. ``Unified Representation of Twitter and Online News using Graph and Entities'', \textit{Frontiers in Big Data, section Big Data Networks}. In press.

\item[J25] *Chou, D., \textbf{Jiang, M.} ``A Survey on Data-Driven Network Intrusion Detection'', \textit{ACM Computing Surveys}. In press. (IF=7.990)
...
\item[JR6] Gu, S., \textbf{Jiang, M.}, Guzzi, P.H., Milenkovic, T. ``Modeling Multi-scale Data via a Network of Networks'', under review at \textit{Bioinformatics}. (IF=5.610)

\item[JR5] @Wang, D., @Zhao, T., @Yu, W., Chawla, N.V., \textbf{Jiang, M.} ``Deep Multimodal Complementarity Learning'', under review at \textit{IEEE Transactions on Knowledge and Data Engineering}. (IF=4.935)

\item[JR4] Syed, M., Krieg, S.J., Wang, D., \textbf{Jiang, M.}, Conway, O., Juneja, V., Subramanian, S., Chawla, N.V. ``Overcoming Data Sparsity and Class Imbalance with Graph Embeddings'', under review at \textit{Social Network Analysis and Mining}.

\item[JR3] \textbf{Jiang, M.}, Jung, T., Karl, R., @Zhao, T. ``Federated Dynamic Graph Neural Networks with Secure Aggregation for Video-based Distributed Surveillance'', under review at \textit{ACM Transactions on Intelligent Systems and Technology}. (Special issue on Federated Learning, IF=2.861)

\item[JR2] @Yu, W., Zhu, C., *Li, Z., Hu, Z., Wang, Q., Ji, H., \textbf{Jiang, M.} ``A Survey of Knowledge-Enhanced Text Generation'', under review at \textit{ACM Computing Surveys}. (IF=6.131)
...
\hspace{-0.75cm}\textit{2021}\textcolor{white}{.}Area Chair (Generation Track), Conference on Empirical Methods in Natural Language Processing (EMNLP)
