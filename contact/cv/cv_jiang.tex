...
\fancypagestyle{firststyle}
{
   ...
   \fancyhead[R]{\vspace{-2cm}\footnotesize Last updated February 28, 2021}
}
...
\item[P19] @Yu, W., Wu, L., @Zeng, Q., Deng, Y., Mahindru, R., Guven, S., \textbf{Jiang, M.} ``Technical Question Answering across Tasks and Domains'', in \textit{arXiv preprint arXiv:2010.09780}, October 2020.
...
\item[CR10] @Yu, W., \textbf{Jiang, M.} ``A Structured Review of Multi-task Neural Training in NLP'', under review at \textit{the 30th International Joint Conference on Artificial Intelligence} (IJCAI), 2021. (Survey track)
		
\item[CR9] \textbf{Jiang, M.} ``Cross-Network Learning with Partially Aligned Graph Convolutional Networks'', \textit{ACM SIGKDD International Conference on Knowledge Discovery and Data Mining} (KDD), 2021.

\item[CR8] @Zeng, Q., Lin, J., Yu, W., Cleland-Huang, J., \textbf{Jiang, M.} ``Enhancing Taxonomy Completion with Concept Generation via Fusing Relational Representations'', \textit{ACM SIGKDD International Conference on Knowledge Discovery and Data Mining} (KDD), 2021.

\item[CR7] @Zhao, T., *Ni, B., @Yu, W., Guo, Z., Shah, N., \textbf{Jiang, M.} ``Action Sequence Augmentation for Early Graph-based Anomaly Detection'', under review at \textit{ACM SIGKDD International Conference on Knowledge Discovery and Data Mining} (KDD), 2021.

\item[CR6] @Yu, W., Zhu, C., @Zhao, T., Guo, Z., \textbf{Jiang, M.} ``Sentence-Permuted Paragraph Generation'', under review at \textit{Annual Meeting of the Association for Computational Linguistics} (ACL), 2021.

\item[CR5] *Dong, X., @Yu, W., Zhu, C., \textbf{Jiang, M.} ``Enhancing News Generation with Entity Class Information'', under review at \textit{Annual Meeting of the Association for Computational Linguistics} (ACL), 2021.

\item[CR4] Huang, C., Li, R., Zhang, C., \textbf{Jiang, M.}, Dai, P., Bo, L., Chawla, N.V. ``Multi-Grained Learning of Temporal Hierarchy for Time Series Forecasting'', under review at \textit{the 30th International Joint Conference on Artificial Intelligence} (IJCAI), 2021.
	
\item[CR3] @Anuyah, O., @Douailly-Backman, J.-P., Metoyer, R., \textbf{Jiang, M.} ``Modeling User Behaviors to Predict Hatefulness Level of Posts on Gab'', under review at \textit{the 29th ACM Conference on User Modeling, Adaptation and Personalization} (UMAP), 2021.

\item[CR2] @Yu, W., Wu, L., @Zeng, Q., Deng, Y., Mahindru, R., Guven, S., \textbf{Jiang, M.} ``Technical Question Answering across Tasks and Domains'', under review at \textit{Conference of the North American Chapter of the Association for Computational Linguistics - Human Language Technologies} (NAACL-HLT), 2021.

\item[CR1] Zhu, C., Hinthorn, W., Xu, R., @Zeng, Q., Zeng, M., Huang, X., \textbf{Jiang, M.} ``Enhancing Factual Consistency of Abstractive Summarization'', under review at \textit{Conference of the North American Chapter of the Association for Computational Linguistics - Human Language Technologies} (NAACL-HLT), 2021.

%Lu, Q., Jiang, W., Zhao, Z., \textbf{Jiang, M.}, Hu, J., Dasgupta, S., Shi, Y. ``Hardware/Software Co-Exploration for Graph Neural Architectures on FPGAs'', under review at \textit{} (), 2021.
...
\item[JR9] @Wang, D., @Zhao, T., @Yu, W., Chawla, N.V., \textbf{Jiang, M.} ``Deep Multimodal Complementarity Learning'', under review at \textit{IEEE Transactions on Pattern Analysis and Machine Intelligence}. (IF=17.861)

\item[JR8] Syed, M., Krieg, S.J., Wang, D., \textbf{Jiang, M.}, Conway, O., Juneja, V., Subramanian, S., Chawla, N.V. ``Overcoming Data Sparsity and Class Imbalance with Graph Embeddings'', under review at \textit{Social Network Analysis and Mining}.

\item[JR7] \textbf{Jiang, M.}, Jung, T., Karl, R., @Zhao, T. ``Federated Dynamic Graph Neural Networks with Secure Aggregation for Video-based Distributed Surveillance'', under review at \textit{ACM Transactions on Intelligent Systems and Technology}. (Special issue on Federated Learning, IF=2.861)

\item[JR6] @Zhao, T., @Jiang, T., Shah, N., \textbf{Jiang, M.} ``A Synergistic Approach for Graph Anomaly Detection with Pattern Mining and Feature Learning'', under review at \textit{IEEE Transactions on Neural Networks and Learning Systems}. (IF=8.793)
...
\item[JR4] *Chou, D., \textbf{Jiang, M.} ``Data-Driven Network Intrusion Detection: A Taxonomy of Challenges and Methods'', under review at \textit{ACM Computing Surveys}. (IF=6.131)

\item[JR3] @Wang, D., *Zhang, Z., *Ma, Y., @Zhao, T., @Jiang, T., Chawla, N.V., \textbf{Jiang, M.} ``Modeling Co-evolution of Attributed and Structural Information in Graph Sequence'', under review at \textit{IEEE Transactions on Knowledge and Data Engineering}. (IF=4.935)
