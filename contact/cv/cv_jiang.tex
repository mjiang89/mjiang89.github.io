...
%\item[WR] *Alaphat, A., \textbf{Jiang, M.} ``SmartFund: Predicting Outcomes of NSF-Funded Research Using Machine Learning and Natural Language Processing'', under review at \textit{} (), 2020.
...
%\begin{enumerate}[leftmargin=.5cm]
%
%\item[CR7] Guo, Z., @Yu, W., Zhang, C., \textbf{Jiang, M.}, Chawla, N.V. ``GraSeq: Graph and Sequence Fusion Learning for Molecular Property Prediction'', under review at \textit{ACM International Conference on Information and Knowledge Management} (CIKM), 2020.
%
%\item[CR6] @Wang, D., *Zhang, Z., *Ma, Y., @Zhao, T., @Jiang, T., Chawla, N.V., \textbf{Jiang, M.} ``CoEvoGNNs: Modeling Co-evolution of Attributed and Structural Information in Dynamic Graph Sequence'', under review at \textit{ACM International Conference on Information and Knowledge Management} (CIKM), 2020.
%
%\item[CR5] @Zhao, T., *Deng, C., *Yu, K., @Jiang, T., @Wang, D., \textbf{Jiang, M.} ``Error-bounded Graph Anomaly Loss for GNNs'', under review at \textit{ACM International Conference on Information and Knowledge Management} (CIKM), 2020.
%
