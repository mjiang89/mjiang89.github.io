...
\fancypagestyle{firststyle}
{
   ...
   \fancyhead[R]{\vspace{-2cm}\footnotesize Last updated February 18, 2020}
}
...
\item[CR15] Liu, Y., Lin, J., Zeng, Q., \textbf{Jiang, M.}, Cleland-Huang, J., ``Semantic-aware Trace Links: An Ontology-Driven Approach'', under review at \textit{IEEE International Requirements Engineering Conference} (RE), 2020.		

\item[CR14] @Wang, D., \textbf{Jiang, M.}, Syed, M., Conway, O., Juneja, V., Subramanian, S., Chawla, N.V., ``Calendar Graph Neural Networks for Modeling Time Structures in Spatiotemporal User Behaviors'', under review at \textit{ACM SIGKDD International Conference on Knowledge Discovery and Data Mining} (KDD), 2020.

\item[CR13] @Zhao, T., *Deng, C., *Yu, K., @Jiang, T., @Wang, D., \textbf{Jiang, M.}, ``Error-bounded Graph Anomaly Loss for GNNs'', under review at \textit{ACM SIGKDD International Conference on Knowledge Discovery and Data Mining} (KDD), 2020.

\item[CR12] Zhang, C., Yao, H., Yu, L., Huang, C., Song, D., \textbf{Jiang, M.}, Chen, H., Chawla, N.V., ``Inductive Contextual Personalization'', under review at \textit{ACM SIGKDD International Conference on Knowledge Discovery and Data Mining} (KDD), 2020.

\item[CR11] Shi, X., Shang, J., \textbf{Jiang, M.}, Liu, L., Hanratty, T., Han, J., ``Contrast Subgraph Mining from Coherent Cores'', under review at \textit{ACM SIGKDD International Conference on Knowledge Discovery and Data Mining} (KDD), 2020.

\item[CR10] Jiang, T., Zhang, N., \textbf{Jiang, M.}, Liu, M., Qin, B., Liu, T., ``The Use of Internal Knowledge: Neural Biomedical Literature Search Liberated From External Resources'', under review at \textit{ACM SIGKDD International Conference on Knowledge Discovery and Data Mining} (KDD), 2020.

\item[CR9] Huang, C., Li, R., Zhang, C., \textbf{Jiang, M.}, Dai, P., Bo, L., Chawla, N.V., ``Multi-Grained Learning of Temporal Hierarchy for Time Series Forecasting'', under review at \textit{International Joint Conference on Artificial Intelligence} (IJCAI), 2020.
...
\item[JR5] @Wang, D., @Zeng, Q., Chawla, N.V., \textbf{Jiang, M.} ``Modeling Complementarity in Behavior Data with Multi-Type Itemset Embedding'' under review at \textit{Transactions on Intelligent Systems and Technology}. (IF=3.190)

\item[JR4] \textbf{Jiang, M.}, Ammerman, B.A., @Zeng, Q., Jacobucci, R., Brodersen, A. ``Phrase-level Pairwise Topic Modeling to Uncover Helpful Peer Responses to Online Suicidal Crises'' under review at \textit{Nature Palgrave Communications}. (Major revision)	

\item[JR3] Zhao, S., \textbf{Jiang, M.}, Qin, B., Liu, T., Zhai, C.X., Wang, F. ``Structural and Textual Information Fusion for Symptom and Disease Representation Learning'' under review at \textit{IEEE Transactions on Knowledge and Data Engineering}. (Major revision, IF=2.775)	

\item[JR2] @Jiang, T., @Zeng, Q., @Zhao, T., Qin, B., Liu, T., Chawla, N.V., \textbf{Jiang, M.} ``Biomedical Knowledge Graphs Construction from Conditional Statements'' under review at \textit{IEEE/ACM Transactions on Computational Biology and Bioinformatics}. (Minor revision, IF=2.428)
