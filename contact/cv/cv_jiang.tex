...
\item[CR7] Tang, P., Jiang, M., $\dots$, Xia, B., $\dots$, Chawla, N.V. ``Multi-label Patent Categorization with Attention-based Graph Convolutional Network'', under review at International Conference on Data Mining (ICDM), 2019.
