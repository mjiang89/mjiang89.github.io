...
\fancypagestyle{firststyle}
{
   ...
   \fancyhead[R]{\vspace{-2cm}\footnotesize Last updated March 8, 2021}
}
...
\item[CR9] @Yu, W., \textbf{Jiang, M.} ``A Structured Review of Multi-task Neural Training in NLP'', under review at \textit{the 30th International Joint Conference on Artificial Intelligence} (IJCAI), 2021. (Survey track)
		
\item[CR8] \textbf{Jiang, M.} ``Cross-Network Learning with Partially Aligned Graph Convolutional Networks'', \textit{ACM SIGKDD International Conference on Knowledge Discovery and Data Mining} (KDD), 2021.

\item[CR7] @Zeng, Q., Lin, J., Yu, W., Cleland-Huang, J., \textbf{Jiang, M.} ``Enhancing Taxonomy Completion with Concept Generation via Fusing Relational Representations'', \textit{ACM SIGKDD International Conference on Knowledge Discovery and Data Mining} (KDD), 2021.

\item[CR6] @Zhao, T., *Ni, B., @Yu, W., Guo, Z., Shah, N., \textbf{Jiang, M.} ``Action Sequence Augmentation for Early Graph-based Anomaly Detection'', under review at \textit{ACM SIGKDD International Conference on Knowledge Discovery and Data Mining} (KDD), 2021.

\item[CR5] @Yu, W., Zhu, C., @Zhao, T., Guo, Z., \textbf{Jiang, M.} ``Sentence-Permuted Paragraph Generation'', under review at \textit{Annual Meeting of the Association for Computational Linguistics} (ACL), 2021.

\item[CR4] *Dong, X., @Yu, W., Zhu, C., \textbf{Jiang, M.} ``Enhancing News Generation with Entity Class Information'', under review at \textit{Annual Meeting of the Association for Computational Linguistics} (ACL), 2021.

\item[CR3] Huang, C., Li, R., Zhang, C., \textbf{Jiang, M.}, Dai, P., Bo, L., Chawla, N.V. ``Multi-Grained Learning of Temporal Hierarchy for Time Series Forecasting'', under review at \textit{the 30th International Joint Conference on Artificial Intelligence} (IJCAI), 2021.
