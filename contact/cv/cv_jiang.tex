...
\fancypagestyle{firststyle}
{
   ...
   \fancyhead[R]{\vspace{-2cm}\footnotesize Last updated July 14, 2020}
}
...
\item[CR16] @Yu, W., Wu, L., Deng, Y., Mahindru, R., @Zeng, Q., Guven, S., \textbf{Jiang, M.} ``A Technical Question Answering System with Transfer Learning'', under review at \textit{Conference on Empirical Methods in Natural Language Processing} (EMNLP), 2020. (Demo track)
...
\item[JR2] @Wang, D., @Zeng, Q., Chawla, N.V., \textbf{Jiang, M.} ``Modeling Complementarity in Behavior Data with Multi-Type Itemset Embedding'' under review at \textit{ACM Transactions on Intelligent Systems and Technology}. (Conditional acceptance with minor revision, IF=2.861 in 2018)
...
\hspace{-0.75cm}{\bf Mengxia Yu}, \textit{Ph.D. Student}

\hspace{-0.75cm}{\bf Zhihan Zhang}, \textit{Ph.D. Student}
