...
\fancypagestyle{firststyle}
{
   ...
   \fancyhead[R]{\footnotesize Last updated March 5, 2026}
}
...
\item[C129] Lu, Y., Chen, M., Zhao, Q., Cox, V., Yang, Y., \textbf{Jiang, M.}, Brockman, J., Kay, T., Li, T. ``Crepe: A Mobile Screen Data Collector Using Graph Query'', in Proceedings of \textit{ACM CHI conference on Human Factors in Computing Systems} (CHI), 2026.
