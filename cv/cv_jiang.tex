...
\fancypagestyle{firststyle}
{
   ...
   \fancyhead[R]{\footnotesize Last updated August 21, 2026}
}
...
\item[J49] @Lu, Y., Wang, Z., Li, S., Liu, X., Yu, C., Yin, Q., Shi, Z., Zhang, Z., \textbf{Jiang, M.} ``Learning to Optimize Multi-Objective Alignment Through Dynamic Reward Weighting'', \textit{Transactions of the Association for Computational Linguistics}. February 2026. (to appear)
