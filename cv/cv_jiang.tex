...
\fancypagestyle{firststyle}
{
   ...
   \fancyhead[R]{\footnotesize Last updated October 21, 2025}
}
...
\item[C124] Luo, T., Xu, J., Suleiman, A., @Liu, G., Zhang, R., \textbf{Jiang, M.}, Guo, R. ``High-performance Polymeric Gas Separation Membrane Designed by Explainable Graph Augmented and Imbalanced Machine Learning'', in the \textit{Eighth International Symposium Frontiers in Polymer Science}, 2026.
