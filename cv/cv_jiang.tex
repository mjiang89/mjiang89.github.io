...
\fancypagestyle{firststyle}
{
   ...
   \fancyhead[R]{\footnotesize Last updated March 18, 2024}
}
...
\item[J38] @Liu, G., @Inae, E., Luo, T., \textbf{Jiang, M.} ``Rationalizing Graph Neural Networks with Data Augmentation'', \textit{ACM Transactions on Knowledge Discovery from Data}. Accepted in 2023. (IF=4.2)
...
\textcolor{white}{.}{\bf Zhichun Guo}, Notre Dame Comp. Sci. \& Eng. \\
