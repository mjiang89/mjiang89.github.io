...
\fancypagestyle{firststyle}
{
   ...
   \fancyhead[R]{\footnotesize Last updated November 17, 2024}
}
...
\item[J43] Xu, J., Suleiman, A., @Liu, G., Zhang, R., \textbf{Jiang, M.}, Guo, R., Luo, T. ``Transcend the Boundaries: Machine Learning for Designing Polymeric Membrane Materials for Gas Separation'', \textit{Chemical Physics Reviews}. Accepted in November 2024. (IF=6.6)
