...
\fancypagestyle{firststyle}
{
   ...
   \fancyhead[R]{\footnotesize Last updated August 16, 2023}
}
...
\item[J33] Saebi, M., Kreig, S., Zhang, C., \textbf{Jiang, M.}, Kajdanowicz, T., Chawla, N.V. ``Heterogeneous Relational Reasoning in Knowledge Graphs with Reinforcement Learning'', \textit{Information Fusion}. December 2022. (IF=17.56; DOI: 10.1016/j.inffus.2022.07.001)
	
\item[J32] Liu, Z., \textbf{Jiang, M.}, Luo, T. ``Leveraging Low-Fidelity Data to Improve Machine Learning of Sparse High-Fidelity Thermal Conductivity Data via Transfer Learning'', \textit{Materials Today Physics}. September 2022. (IF=11.021; DOI: 10.1016/j.mtphys.2022.100868)
