...
\fancypagestyle{firststyle}
{
   ...
   \fancyhead[R]{\footnotesize Last updated May 27, 2025}
}
...
\bf{Director of Foundation Models and Applications Lab}&2025 -- \emph{present}\\
...
\item[C115] @Liu, Z., Maharjan, S., Wu, F., Parikh, R., Bayar, B., Sengamedu, S., \textbf{Jiang, M.} ``Disentangling Biased Knowledge from Reasoning in Large Language Models via Machine Unlearning'', in \textit{Annual Meetings of the Association for Computational Linguistics} (ACL), 2025.
...
\item[C113] @Wu, Z., @Zeng, Q., @Zhang, Z., @Tan, Z., Shen, C., \textbf{Jiang, M.} ``Enhancing Mathematical Reasoning in LLMs by Stepwise Correction'', in \textit{Annual Meetings of the Association for Computational Linguistics} (ACL), 2025.
...
\item[C108] @Zhang, Z., Li, S., Zhang, Z., Liu, X., Jiang, H., Tang, X., Gao, Y., Li, Z., Wang, H., @Tan, Z., Li, Y., Yin, Q., Yin, B., \textbf{Jiang, M.} ``IHEval: Evaluating Language Models on Following the Instruction Hierarchy'', in Proceedings of \textit{Annual Conference of the North American Chapter of the Association for Computational Linguistics} (NAACL), 2025.
...
\item[J45] @Jia, M., @Yu, W., Ma, K., Fang, T., @Zhang, Z., Ouyang, S., Zhang, H., \textbf{Jiang, M.}, Yu, D. ``Leopard: A Vision Language Model for Text-Rich Multi-Image Tasks'', \textit{Transactions on Machine Learning Research}. May 2025. (Accepted)
...
\hspace{-0.75cm}{\bf Qingkai Zeng}, \textit{Graduated December 2024} \\
	...
	{Employment: \textit{Postdoctoral Research Associate at Amazon}} \\
...
\hspace{-0.75cm}{\bf Zhihan Zhang}, \textit{Ph.D. Student} (since August 2021) \\
	{Notre Dame CSE Student Choice Best Poster Award 2023}
...
\hspace{-0.75cm}{\bf Katherine O'Roark} (Saint Mary's College), \textit{Undergraduate Student} (since January 2025)
...
\textcolor{white}{.}{\bf EK Lu}, Notre Dame Psychology \\
...
ACL Rolling Review: \\
(Review: Feb/Apr/June/Aug/Oct 2024, Feb 2025, AC: Dec 2024)
