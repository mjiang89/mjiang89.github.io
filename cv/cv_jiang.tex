...
\fancypagestyle{firststyle}
{
   ...
   \fancyhead[R]{\footnotesize Last updated September 24, 2026}
}
...
174 Fitzpatrick Hall \hfill \url{mjiang2@nd.edu}\\
Notre Dame, IN 46556 \hfill +1 (217) 418--6072
...
\bf{Frank M. Freimann Collegiate Professor}&2025 -- \emph{present}\\
\bf{Fellow, Lucy Family Institute}&2024 -- \emph{present}\\
\bf{Fellow, Institute for Educational Initiatives}&2026 -- \emph{present}\\
...
%\\
%\bf{Amazon Scholar}&2025 -- \emph{present}\\
%\bf{Amazon Visiting Academics}&2023 -- 2025\\
% \multicolumn{2}{l}{~{Amazon}}\\
\\
...
\vspace{-0.6cm}
\subsection{\sc Research Interests}
\vspace{-0.4cm} \line(1,0){370} \vspace{0.1cm}

AI and Data Science: Develop \emph{strong}, \emph{controllable}, \emph{multimodal} AI for applications such as Sciences (e.g., materials discovery, math reasoning) and Engineering (e.g., physical systems, recommender systems), as well as Education and Mental Health.

%\vspace{-0.6cm}
\subsection{\sc Scholar Pages}
\vspace{-0.4cm} \line(1,0){370} \vspace{-0.5cm}
\begin{table}[h!]
...
\begin{table}[h!]
\begin{tabular*}{12.7cm}{p{11.65cm}r}
Chief of Naval Research (CNR) Fellows Finalist & 2026 \\
CHI Honourable Mention Award & 2026 \\
CSEE JPES 10th Anniversary High Impact Paper & 2025 \\
Editor's Pick from ACM TODAES & 2025 \\
EMNLP Outstanding Paper & 2023 \\
IEEE Senior Member \& ACM Senior Member & 2023 \\
NSF CAREER Award & 2022 \\
ACM CIKM Conference Best Reviewer & 2021 \\	
ACM SIGSOFT (ICSE) Distinguished Paper & 2021 \\
ACM SIGKDD-DLG Workshop Best Paper & 2020 \\
ISDSA Annual Meeting Best Paper & 2020 \\
...
\vspace{-0.6cm}
\subsection{\sc Grants, Contracts, and Gifts}
\vspace{-0.4cm} \line(1,0){370} \vspace{-0.1cm}

\begin{myindentpar}{0.75cm}

\hspace{-0.75cm}External funds: Total amount: \$9,472,107; Total credit: \textbf{\$4,353,694}

\hspace{-0.75cm}``Probing-Guided Robust Unlearning'' \\
January 1, 2026 -- June 30, 2027 \\
Funding Vehicle: Open Philanthropy and Good Ventures Foundation \\
Amount: \textbf{\$281,628} \\
Role: {Sole PI}
...
September 1, 2024 -- June 30, 2027 \\
Funding Vehicle: Center for Open Science \\
Amount: \textbf{\$159,800} \\
Role: {ND Lead PI}

\hspace{-0.75cm}``OpenCARE: Open-Source Infrastructure for Evaluating Conversational AI in Dementia
Care'' \\
September 1, 2026 -- August 31, 2027 \\
Funding Vehicle: National Institutes of Health (NIH) \\
Amount: \$582,492 (Credit: 17.7\%; \textbf{\$102,818}) \\
Role: {Co-PI} \\
Other PI: Zhi Zheng (ND; Lead PI), Yiyu Shi (ND), Jarek Nabrzyski (ND), Malaz Boustani (IU School of Medicine)

\hspace{-0.75cm}``Adaptive Communication Enhancement for Children with Autism Spectrum Disorder (ACE-AI for Autism)'' (Contract) \\
March 10, 2026 -- March 9, 2027 \\
Funding Vehicle: ARPA-H, subaward from VoiceLove Inc. \\
Amount: \$599,276 (Credit: 2\%; \textbf{\$12,047}) \\
Role: {Co-PI} \\
Other PI: Jarek Nabrzyski (ND; Lead PI)
...
June 1, 2022 -- May 31, 2025 (\emph{Completed}) \\
...
September 15, 2021 -- August 31, 2025 (\emph{Completed}) \\
Funding Vehicle: National Science Foundation (NSF) \\
...
August 15, 2019 -- July 31, 2025 (\emph{Completed}) \\
Funding Vehicle: National Science Foundation (NSF) \\
...
\hspace{-0.75cm}Event Organizing Fund: ``PhysicalAI Faculty Working Group''\\
January--May, 2026 \\
Funding Vehicle: Data, AI, and Computing (DAC) Initiative at ND \\
Amount: \$10,000

\hspace{-0.75cm}Event Organizing Fund: ``Midwest Speech and Language Days 2025''\\
April 15--16, 2025 (\emph{Completed}) \\
Funding Vehicles: Multiple \\
Amount: \$23,000 (Credit: 50\%; \textbf{\$11,500}) \\
Other PI: David Chiang (ND)

\hspace{-0.75cm}Research Credits: ``Inference-Time Safety Calibration for Specialized AI Agents''\\
...
\hspace{-0.75cm}Unrestricted Gift: ``Copolymer Discovery'' \\
March 1, 2026 \\
Funding Vehicle: P\&G \\
Amount: \textbf{\$25,000} (Credit: 50\%; \textbf{\$12,500}) \\
Other PI: Tengfei Luo (ND; Lead PI)
...
June 1, 2022 -- August 15, 2023 (\emph{Completed}) \\
...
January 1, 2022 -- December 31, 2022 (\emph{Completed}) \\
...
\subsection{\sc {\small \textit{(@ indicates supervised graduate students or postdocs. * indicates supervised undergraduate and highschool students.)}}}
\subsection{\sc Publications}
\vspace{-0.4cm} \line(1,0){370} \vspace{-0.1cm}

\begin{myindentpar}{0.00cm}

\hspace{-0.25cm}\textit{Peer-reviewed Conference Papers}

\begin{enumerate}[leftmargin=.5cm]

\item[C151] @Zhu, Y., Liu, Y., @Li, W., Luo, T., \textbf{Jiang, M.} ``Controllable Molecular Generative Foundation Models'', in Proceedings of \textit{Conference on Neural Information Processing Systems} (NeurIPS), 2026.

\item[C150] @Tan, Z., Zhai, X., Zhu, Y., \textbf{Jiang, M.}, Hammad, M. ``Bridging Textual Profiles and Latent User Embeddings for Personalization'', in Proceedings of \textit{Conference on Neural Information Processing Systems} (NeurIPS), 2026.
		
\item[C149] *Kang, D., @Liu, Z., Ma, N., Huang, Y., @Tan, Z., \textbf{Jiang, M.} ``Prompt-Activation Duality: Improving Activation Steering via Attention-Level Interventions'', in Proceedings of \textit{Conference on Neural Information Processing Systems} (NeurIPS), 2026.

\item[C148] @Dang, H., *Dao, Q., \textbf{Jiang, M.} ``Open, Reliable, and Collective: A Community-Driven Framework for Tool-Using AI Agents'', in Proceedings of \textit{Conference on Empirical Methods in Natural Language Processing} (EMNLP), 2026. (Demostration track)

\item[C147] Soos, D., \textbf{Jiang, M.}, Wu, J. ``KnowledgeGain: Evaluating and Optimizing Science News Generation for Reader Learning'', in Proceedings of \textit{Conference on Empirical Methods in Natural Language Processing} (EMNLP), 2026.

\item[C146] @Liu, Z., Xu, Z., Dou, G., Yuan, X., @Tan, Z., Poovendran, R., \textbf{Jiang, M.} ``Safety-Aware Contrastive Decoding for Contextual Safety in Multimodal Large Language Models'', in Proceedings of \textit{Conference on Empirical Methods in Natural Language Processing} (EMNLP), 2026.

\item[C145] @Jia, M., @Zhang, Z., \textbf{Jiang, M.} ``Prioritizing the Best: Incentivizing Reliable Multimodal Reasoning by Rewarding Beyond Answer Correctness'', in Findings of \textit{Conference on Empirical Methods in Natural Language Processing} (EMNLP), 2026.

\item[C144] Zhao, G., Zheng, J., Boustani, M., Nabrzyski, J., Shi, Y., \textbf{Jiang, M.}, Zheng, Z. ``ADRD-Bench: An LLM Benchmark for Alzheimer’s Disease and Related Dementias'', in Findings of \textit{Conference on Empirical Methods in Natural Language Processing} (EMNLP), 2026.

\item[C143] @Xing, S., Wu, K., Xia, X., He, H., \textbf{Jiang, M.}, Chen, J., Fu, T. ``ClinicalReTrial: Clinical Trial Redesign with Self-Evolving Agents'', in Findings of \textit{Conference on Empirical Methods in Natural Language Processing} (EMNLP), 2026.
		
\item[C142] @Nguyen, B., Soos, D., Ma, Q., Obadage, R.R., Ranjan S., Koneru, S., Errington, T.M., Nematova, S., Rajtmajer, S., Wu, J., \textbf{Jiang, M.} ``ReplicatorBench: Benchmarking LLM Agents on Replicability Studies in Social and Behavioral Sciences'', in Proceedings of \textit{ACM SIGKDD International Conference on Knowledge Discovery and Data Mining} (KDD), 2026. (AI4Sciences Track)

\item[C141] Nogueira, B., Gonzalez-Montiel, G.A., \textbf{Jiang, M.}, Chawla, N.V., Moniz, N. ``SPECTRA: Spectral Domain-Aware Graph Generation for Imbalanced Molecular Property Regression'', in Proceedings of \textit{ACM SIGKDD International Conference on Knowledge Discovery and Data Mining} (KDD), 2026. (AI4Sciences Track)

\item[C140] @Ziems, N., Soylu, D., Agrawal, L., Miller, I., Lai, L., Qian, C., Song, K., \textbf{Jiang, M.}, Klein, D., Zaharia, M., D'Oosterlinck, K., Potts, C., Khattab, O. ``Composing Policy Gradients and Prompt Optimization for Language Model Programs'', in \textit{ACM Conference on AI and Agentic Systems} (CAIS), 2026.

\item[C139] Chabra, O., @Ziems, N., \textbf{Jiang, M.}, Khattab, O., Balakrishnan, H., ``Dossier: Deep Research via Ledger-Driven Branching Search and Query Encoding Learning'', in \textit{ACM Conference on AI and Agentic Systems} (CAIS), 2026.

\item[C138] @Dang, H., Lu, Y., Spicer, J., Kay, T., Yang, D., Yang, Y., Brockman, J., \textbf{Jiang, M.}, Li, T. ``Uncovering Disparities in Rideshare Drivers Earning and Work Patterns: A Case Study of Chicago'', in \textit{ACM SIGCHI Conference on Computer-Supported Cooperative Work \& Social Computing} (CSCW), 2026.

\item[C137] *Yang, T., *Guo, S., @Jia, M., Su, J., Liu, Y., @Zhang, Z., \textbf{Jiang, M.} ``MMTutorBench: The First Multimodal Benchmark for AI Math Tutoring'', in \textit{Annual Meeting of the Association for Computational Linguistics} (ACL), 2026.

\item[C136] @Tan, Z., Zhang, Z., Wen, H., Li, Z., Zhang, R., Chen, P., Mo, F., @Liu, Z., @Zeng, Q., Yin, Q., \textbf{Jiang, M.} ``Instant Personalized Large Language Model Adaptation via Hypernetwork'', in \textit{Annual Meeting of the Association for Computational Linguistics} (ACL), 2026.

\item[C135] Li, M., Chen, P., Zhang, Z., Yang, T., Zhang, X., Li, H., Cao, T., Zeng, M., Wu, Z., \textbf{Jiang, M.}, Li, H., Li, L., Yin, B. ``Mitigating Lost in Multi-turn Conversation via Curriculum RL with Verifiable Accuracy and Abstention Rewards'', in \textit{Annual Meeting of the Association for Computational Linguistics} (ACL), 2026.

\item[C134] @Jia, M., @Zhang, Z., Cases, I., @Liu, F., \textbf{Jiang, M.}, Qi, P. ``AutoRubric: Rubric-Based Generative Rewards for Faithful Multimodal Reasoning'', in \textit{Findings of the Association for Computational Linguistics} (ACL), 2026.

\item[C133] @Liu, Z., Xiao, L., Li, Y., Yun, H., Li, L., Zhang, C., \textbf{Jiang, M.} ``Do LLMs Catch Their Own Mistakes? A Comprehensive Benchmark for Reflective Tool Use LLMs'', in \textit{Findings of the Association for Computational Linguistics} (ACL), 2026.

\item[C132] @Liu, Z., *Kim, D., Wan, Y., Yuan, X., @Tan, Z., Mo, F., \textbf{Jiang, M.} ``MTMCS-Bench: Evaluating Contextual Safety of Multimodal Large Language Models in Multi-Turn Dialogues'', in \textit{Findings of the Association for Computational Linguistics} (ACL), 2026.

\item[C131] Mo, F., Gao, Y., Li, S., Zeng, H., Liu, X., @Tan, Z., Li, X., Chen, J., Wang, D., \textbf{Jiang, M.} ``Agentic Conversational Search with Contextualized Reasoning via Reinforcement Learning'', in \textit{Findings of the Association for Computational Linguistics} (ACL), 2026.

\item[C130] Qi, R., Mo, F., Chen, Y., Zhang, X., Wang, S., Li, H., Xu, J., \textbf{Jiang, M.}, Nie, J., Huang, K. ``Language-Coupled Reinforcement Learning for Multilingual Retrieval-Augmented Generation'', in \textit{Findings of the Association for Computational Linguistics} (ACL), 2026.

\item[C129] Lu, Y., Chen, M., Zhao, Q., Cox, V., Yang, Y., \textbf{Jiang, M.}, Brockman, J., Kay, T., Li, T. ``Crepe: A Mobile Screen Data Collector Using Graph Query'', in Proceedings of \textit{ACM CHI conference on Human Factors in Computing Systems} (CHI), 2026. (Selected for \textbf{Honourable Mention Award})

\item[C128] @Liu, G., Chen, J., @Zhu, Y., Sun, M., Luo, T., Chawla, N.V., \textbf{Jiang, M.} ``Graph Diffusion Transformers are In-Context Molecular Designers'', in Proceedings of \textit{International Conference on Learning Representations} (ICLR), 2026.

\item[C127] *Yan, H., @Liu, Z., \textbf{Jiang, M.} ``Dual-Space Smoothness for Robust and Balanced LLM Unlearning'', in Proceedings of \textit{International Conference on Learning Representations} (ICLR), 2026.

\item[C126] Agrawal, L.A., Tan, S., Soylu, D., @Ziems, N., Khare, R., Opsahl-Ong, K., Singhvi, A., Shandilya, H., Ryan, M.J., \textbf{Jiang, M.}, Potts, C., Sen, K., Dimakis, A., Stoica, I., Klein, D., Zaharia, M., Khattab, O. ``GEPA: Reflective Prompt Evolution Can Outperform Reinforcement Learning'', in Proceedings of \textit{International Conference on Learning Representations} (ICLR), 2026.

\item[C125] @Yu, M., @Nguyen, B., *Zino, O., \textbf{Jiang, M.} ``Context Selection and Rewriting for Video-based Educational Question Generation'', in the \textit{Symposium on Educational Advances in Artificial Intelligence} (EAAI), 2026.

\item[C124] Luo, T., Xu, J., Suleiman, A., @Liu, G., Zhang, R., \textbf{Jiang, M.}, Guo, R. ``High-performance Polymeric Gas Separation Membrane Designed by Explainable Graph Augmented and Imbalanced Machine Learning'', in the \textit{International Symposium Frontiers in Polymer Science}, 2026.
		
\item[C123] @Zhu, Y., @Liu, G., @Inae, G., Luo, T., \textbf{Jiang, M.} ``Learning Repetition-Invariant Representations for Polymer Informatics'', in \textit{Annual Conference on Neural Information Processing Systems} (NeurIPS), 2025.

\item[C122] *He, Y., @Zeng, Q., \textbf{Jiang, M.} ``Pre-trained Models Perform the Best When Token Distributions Follow Zipf’s Law'', in \textit{Conference on Empirical Methods in Natural Language Processing} (EMNLP), 2025.

\item[C121] @Dang, H., Liu, T., Wu, Z., Yang, J., Jiang, H., Yang, T., Chen, P., Wang, Z., Wang, H., Li, H., Yin, B., \textbf{Jiang, M.} ``Improving Large Language Models Function Calling and Interpretability via Guided-Structured Templates'', in \textit{Conference on Empirical Methods in Natural Language Processing} (EMNLP), 2025.
...
\item[C77] @Ziems, N., @Yu, W., @Zhang, Z., \textbf{Jiang, M.} ``Large Language Models are Built-in Autoregressive Search Engines'', in \textit{Findings of Association for Computational Linguistics} (ACL), 2023.
...
\hspace{-0.25cm}\textit{Peer-reviewed Journal Papers}

\begin{enumerate}[leftmargin=.5cm]

\item[J53] Chen, Y., Liu, X., Wang, R., Li, Z., Chen, P., Yu, C., Yin, Q., Nigam, P., \textbf{Jiang, M.}, Yin, B. ``POPI: Personalizing LLMs via Optimized Natural Language Preference Inference'', \textit{Transactions on Machine Learning Research}. 2026. (to appear)

\item[J52] Ni, B., @Liu, Z., Wang, L., Lei, Y., Zhao, Y., Cheng, X., @Zeng, Q., Dong, L., Xia, Y., Kenthapadi, K., Rossi, R., Dernoncourt, F., Tanjim, M.M., Ahmed, N., Liu, X., Fan, W., Blasch, E., Wang, Y., \textbf{Jiang, M.} ``Towards Trustworthy Retrieval Augmented Generation for Large Language Models: A Survey'', \textit{ACM Computing Surveys}. July 2026. (to appear)
	
\item[J51] Chawla, N., González-Montiel, G.A., Guo, K., Guo, T., Hua, T., Huang, X., @Inae, E., \textbf{Jiang, M.}, Le, K., @Liu, G., Maier, J.C., Moniz, N., Nogueira, B., Pan, D., Piguave, B.V., Savoie, B.M., Schofield, A.B., Shen, Y., Taylor, A., Zhang, X., @Zhu, Y., Wiest, O. ``Organic Chemistry as a Catalyst for AI Innovation: Challenges, Methods, and Emerging Paradigms'', \textit{Chemical Reviews}. June 2026. (IF=64.2; DOI: 10.1021/acs.chemrev.5c01081)

\item[J50] Hou, Z., Zhang, A., @Lu, Y., Baghel, B.K., Brei, A., Lu, X., \textbf{Jiang, M.}, Brahman, F., Chaturvedi, S., Chang, H-S., Khashabi, D., Li, X., ``CreativityPrism: A Holistic Evaluation Framework for Large Language Model Creativity'', \textit{Transactions on Machine Learning Research}. June 2026. (to appear)

\item[J49] @Lu, Y., Wang, Z., Li, S., Liu, X., Yu, C., Yin, Q., Shi, Z., Zhang, Z., \textbf{Jiang, M.} ``Learning to Optimize Multi-Objective Alignment Through Dynamic Reward Weighting'', \textit{Transactions of the Association for Computational Linguistics}. February 2026. (Presentation at EMNLP 2026)

\item[J48] Mo, F., Gao, Y., Wu, Z., Liu, X., Chen, P., Li, Z., Wang, Z., Li, X., \textbf{Jiang, M.}, Nie, J. ``Leveraging Historical Information to Boost Retrieval-Augmented Generation in Conversations'', \textit{Information Processing and Management}. October 2025. (IF=6.9)
		
\item[J47] @Alosious, S., \textbf{Jiang, M.}, Luo, T. ``Computation and Machine Learning for Materials: Past, Present, and Future Perspectives'', \textit{MRS Bulletin: 50th Anniversary}, Springer Nature. September 2025. (IF=4.9; DOI: 10.1557/s43577-025-00959-y)
	
\item[J46] Liu, Y., @Alosious, S., Zhou, J., \textbf{Jiang, M.}, Luo, T. ``Machine Learning in Nanoscale Thermal Transport'', \textit{
Annual Review of Heat Transfer}. June 2025.

\item[J45] @Jia, M., @Yu, W., Ma, K., Fang, T., @Zhang, Z., Ouyang, S., Zhang, H., Yu, D., \textbf{Jiang, M.} ``Leopard: A Vision Language Model for Text-Rich Multi-Image Tasks'', \textit{Transactions on Machine Learning Research}. May 2025.

\item[J44] Qin, R., Liu, D., Xu, C., Yan, Z., Tan, Z., Jia, Z., Nassereldine, A., Li, J., \textbf{Jiang, M.}, Abbasi, A., Xiong, J., Shi, Y. ``Empirical Guidelines for Deploying LLMs onto Resource-constrained Edge Devices'', \textit{ACM Transactions on Design Automation of Electronic Systems}. May 2025. (Accepted; \textbf{Selected as the Editor's Pick from Issue 5, 2025})
...
\item[J12] Zhou, S., Hu, Z., Gu, W., \textbf{Jiang, M.}, Zhang, X.P. ``Artificial Intelligence based Smart Energy Community Management: A Reinforcement Learning Approach'' \textit{CSEE Journal of Power and Energy Systems}. 5:1, 1-10, March 2019. (IF=2.680; DOI: 10.17775/CSEEJPES.2018.00840; Received \textbf{CSEE JPES 10th Anniversary High Impact Paper Award} in 2025)
...
\hspace{-0.25cm}\textit{Peer-reviewed Workshop Papers}

\begin{enumerate}[leftmargin=.5cm]

\item[W41] @Nguyen, B., Soos, D., Ma, Q., Obadage, R.R., Ranjan S., Koneru, S., Errington, T.M., Nematova, S., Rajtmajer, S., Wu, J., \textbf{Jiang, M.} ``ReplicatorBench: Benchmarking LLM Agents on Replicability Studies in Social and Behavioral Sciences'', in the \textit{SciSoc Agents \& LLMs} in conjunction with \textit{ACM SIGKDD International Conference on Knowledge Discovery and Data Mining} (KDD), 2026.

\item[W40] @Liu, G., Sun, M., Matusik, W., \textbf{Jiang, M.}, Chen, J. ``Multimodal Large Language Models for Inverse Molecular Design with Retrosynthetic Planning'', in the \textit{AI for Science Workshop} (AI4Science) in conjunction with \textit{Annual Conference on Neural Information Processing Systems} (NeurIPS), 2025.

\item[W39] @Ziems, N., Soylu, D., Agrawal, L., Miller, I., Lai, L., Qian, C., Song, K., \textbf{Jiang, M.}, Klein, D., Zaharia, M., D'Oosterlinck, K., Potts, K., Khattab, O. ``Multi-module GRPO: Composing Policy Gradients and Prompt Optimization for Language Model Programs'', in the \textit{First Workshop on Foundations of Reasoning in Language Models} (FoRLM) in conjunction with \textit{Annual Conference on Neural Information Processing Systems} (NeurIPS), 2025.

\item[W38] Agrawal, L., Tan, S., Soylu, D., @Ziems, N., Khare, R., Opsahl-Ong, K., Singhvi, A., Shandilya, H., Ryan, M., \textbf{Jiang, M.}, Potts, C., Sen, K., Dimakis, A., Stoica, I., Klein, D., Zaharia, M., Khattab, O. ``GEPA: Reflective Prompt Evolution Can Outperform Reinforcement Learning'', in the \textit{First Workshop on Foundations of Reasoning in Language Models} (FoRLM) in conjunction with \textit{Annual Conference on Neural Information Processing Systems} (NeurIPS), 2025.
...
\item[T16] @Liu, Z., Wan, Y., Chang, K.W., \textbf{Jiang, M.}, Zhao, J., Dziri, N., Anil, C., Mao, Y. ``Knowledge Control for Responsible Generative AI: Bridging Academia, Industry, and Society'' in the \textit{Annual Meeting of the Association for Computational Linguistics} (ACL), July 2026.
...
\item[B2] \textbf{Jiang, M.} ``Behavior Modeling in Social Networks'' Encyclopedia of Social Network Analysis and Mining, Springer, New York, NY, 2018.
...
\item[P1] Yu, W., Wu, L., Deng, Y., Zeng, Q., Mahindru, R., Guven, S., \textbf{Jiang, M.} ``System and Method for Technical Question Answering across Tasks and Domains'' October 24, 2023. (US11797611B2)

\item[P2] Xu, J., Guo, R., \textbf{Jiang, M.}, Luo, T., Suleiman, A., Liu, G. ``Methods and Apparatus for Gas Separation Membrane'' September 2024. (US20240316492A1)
...
\hspace{-0.75cm} ``Could LLMs help design our next medicines and materials?'': MIT News by Adam Zewe, April 9, 2025. (\url{https://news.mit.edu/2025/could-llms-help-design-our-next-medicines-and-materials-0409}, [C105], ICLR 2025)

\hspace{-0.75cm} ``Towards Safer Large Language Models through Machine Unlearning'': Anybody Can Prompt (ABCP), June 8, 2024. (\url{https://anybodycanprompt.substack.com/p/machine-unlearning-selective-knowledge}, [C88], ACL 2024)

\hspace{-0.75cm} ``For Better Answers, Generate Reference Text'': DeepLearning.AI - The Batch - Weekly Issues - Issue 195, May 3, 2023. (\url{https://www.deeplearning.ai/the-batch/issue-195/}, [C75], ICLR 2023)
...
\hspace{-0.75cm} Talk at University of Chicago AI in Science Seminar, October 2026
	
\hspace{-0.75cm} Talk in Scientific Machine Learning Workshop at University of Notre Dame, September 2026

\hspace{-0.75cm} Talk at NEC Laboratories Europe NLP Seminar, Zoom, September 2026

\hspace{-0.75cm} Keynote speech at the KDD Workshop on Resource-Efficient Learning for Knowledge Discovery, August 2026

\hspace{-0.75cm} Keynote speech at the WSDM Workshop on Generative AI for Recommender Systems and Personalization, Boise, ID, February 2026

\hspace{-0.75cm} Talk in Scientific AI Winter School at University of Puerto Rico, January 2026
...
\subsection{\sc Past Postdoc Supervised}
\vspace{-0.4cm} \line(1,0){370} \vspace{-0.1cm}

\begin{myindentpar}{0.75cm}

\hspace{-0.75cm}{\bf Sobin Alosious}, \textit{Lucy Institute Postdoc Fellow} (August 2024--July 2026) \\
	{Co-advised with Prof. Tengfei Luo (ND AME)} \\
	{Employment: \textit{Postdoctoral Research Associate at MIT}}	
...
\hspace{-0.75cm}{\bf Qingkai Zeng}, \textit{Graduated December 2024} \\
	...
	{Employment: \textit{Assistant Professor at Nankai University}} \\	
...
\hspace{-0.75cm}{\bf Mengxia Yu}, \textit{Graduated May 2026} \\
	{Dissertation: \textit{Knowledge Enhanced Text Generation for Scientific Research and Education}} \\
	{First Employment: \textit{Research Scientist at Apple}} \\
	{Notre Dame CSE Select Fellowship}

\hspace{-0.75cm}{\bf Gang Liu}, \textit{Graduated June 2026} \\
	{Dissertation: \textit{Data-Centric Machine Learning and Foundation Models for Molecular Discovery}} \\
	{First Employment: \textit{Assistant Professor at the City University of Hong Kong}} \\
...
\hspace{-0.75cm}{\bf Rebekah Fang} and {\bf Libby Garnett}, \textit{Trinity High School Students} (August 2020--December 2021) \\
	Won the 2nd place in the 2021 Northern Indiana Regional Science and Engineering Fair (NIRSEF). Recommended to the 33rd Annual Hoosier Science and Engineering Fair (HSEF).
...
\hspace{-0.75cm}{\bf Albert Lu}, \textit{Culver Academies High School Student} (August 2022--December 2024) \\
	{Won the 1st place in the 2023 and 2024 NIRSEF. Recommended to the 35th HSEF.} \\
	{Attended and presented in the 2023 SIGKDD Conference on Knowledge Discovery and Data Mining, Los Angeles, CA}

\hspace{-0.75cm}{\bf Kaiyi Zhao}, \textit{Penn High School Student} (June--August 2025)
...
\hspace{-0.75cm}{\bf Olivia Zino}, \textit{Undergraduate Student} (August 2024--December 2025)

\hspace{-0.75cm}{\bf Lang Li}, \textit{Undergraduate Student} (August 2024--May 2026)

\hspace{-0.75cm}{\bf Ethan Sotka}, \textit{Undergraduate Student} (August--December 2025)

\hspace{-0.75cm}{\bf Jack Keller}, \textit{Undergraduate Student} (August--December 2025)

\hspace{-0.75cm}{\bf Ralph Gonzalez}, \textit{Undergraduate Student} (August--December 2025)

\hspace{-0.75cm}{\bf Christopher Bond}, \textit{Undergraduate Student} (August--December 2025)

\hspace{-0.75cm}{\bf Tim Gunn}, \textit{Undergraduate Student} (August--December 2025)

\hspace{-0.75cm}{\bf Zach Petko}, \textit{Undergraduate Student} (January 2025--May 2026) \\
	{Notre Dame iTREDS Scholar}

\hspace{-0.75cm}{\bf Vince Andriacco}, \textit{Undergraduate Student} (January 2025--May 2026) \\
	{Notre Dame iTREDS Scholar}

\hspace{-0.75cm}{\bf John Kim}, \textit{Undergraduate Student} (January 2025--May 2026) \\
	{NSF Graduate Research Fellowship Program (GRFP)} \\
	{Notre Dame iTREDS Scholar}
	
\hspace{-0.75cm}{\bf Katherine O'Roark} (SMC), \textit{Undergraduate Student} (January 2025--May 2026) \\
	{Notre Dame iTREDS Scholar}

\hspace{-0.75cm}{\bf Luke Cao}, \textit{Undergraduate Student} (August 2025--May 2026)

\hspace{-0.75cm}{\bf Max Johnson}, \textit{Undergraduate Student} (August 2025--May 2026)

\hspace{-0.75cm}{\bf Anna Arnett}, \textit{Undergraduate Student} (since January 2026--May 2026)
...
\hspace{-0.75cm}{\bf Quang Dao}, \textit{Visiting Undergraduate Student} (May--September 2025)

\hspace{-0.75cm}{\bf Beibei Liu}, \textit{Visiting Undergraduate Student} (June--July 2025)

\hspace{-0.75cm}{\bf Han Yan}, \textit{Visiting Undergraduate Student} (June--July 2025)

\hspace{-0.75cm}{\bf Tengchao Yang}, \textit{Visiting Undergraduate Student} (June--July 2025)

\hspace{-0.75cm}{\bf Sichen Guo}, \textit{Visiting Undergraduate Student} (July--August 2025)

\hspace{-0.75cm}{\bf Xuanjia Qiao}, \textit{Visiting Undergraduate Student} (July--August 2025)
...
\hspace{-0.75cm}{\bf Orlando Barreto}, \textit{Ph.D. Student in AME} (September--December 2025) \\
	{Scientific AI Fellow}
...
\hspace{-0.75cm}{\bf Bang Nguyen}, \textit{Ph.D. Candidate} (since August 2022)

\hspace{-0.75cm}{\bf Noah Ziems}, \textit{Ph.D. Candidate} (since May 2022) \\
	{Kaneb Center Outstanding Teaching Assistant Award 2023}

\hspace{-0.75cm}{\bf Hy Dang}, \textit{Ph.D. Candidate} (since August 2022)

\hspace{-0.75cm}{\bf Eric Inae}, \textit{Ph.D. Candidate} (since August 2022) \\
	{Notre Dame Dean's Fellowship}

\hspace{-0.75cm}{\bf Zheyuan (Frank) Liu}, \textit{Ph.D. Candidate} (since August 2023)

\hspace{-0.75cm}{\bf Zhaoxuan Tan}, \textit{Ph.D. Candidate} (since August 2023)
...
\hspace{-0.75cm}{\bf Yihan Zhu}, \textit{Ph.D. Student} (since August 2024) \\
	{Scientific AI PhD Fellow Fall 2026}

\hspace{-0.75cm}{\bf Weijiang (Vicky) Li}, \textit{Ph.D. Student} (since January 2026)

\hspace{-0.75cm}{\bf Chuhan Wang}, \textit{Ph.D. Student} (since May 2026)

\hspace{-0.75cm}{\bf Jinduo Guo}, \textit{Ph.D. Student} (since June 2026)

\hspace{-0.75cm}{\bf Trevor Carter}, \textit{Ph.D. Student} (since September 2026) \\
	{Richard and Peggy Notebaert Premier Fellowship}	

\hspace{-0.75cm}{\bf Renzheng Zhang}, \textit{Ph.D. Student in AME} (since January 2026) \\
	{Scientific AI PhD Fellow Spring 2026}
...
\hspace{-0.75cm}{\bf Patrick Williams}, \textit{Undergraduate Student} (since August 2025)

\hspace{-0.75cm}{\bf Kristofer Ulanday}, \textit{Undergraduate Student} (since January 2026)

\hspace{-0.75cm}{\bf Vazgen Manukyan}, \textit{Penn High School Student} (since August 2025)

\hspace{-0.75cm}{\bf Xuanjia Qiao}, \textit{Visiting Undergraduate Student} (July--August 2025)

\hspace{-0.75cm}{\bf Mingyue Cui}, \textit{Visiting Undergraduate Student} (since June 2026)

\hspace{-0.75cm}{\bf Yingying Guo}, \textit{Visiting Undergraduate Student} (since June 2026)

\hspace{-0.75cm}{\bf Zimin Chen}, \textit{Visiting Undergraduate Student} (since July 2026)

\hspace{-0.75cm}{\bf Huipeng Huang}, \textit{Visiting Undergraduate Student} (since July 2026)

\hspace{-0.75cm}{\bf Xingyu Li}, \textit{Visiting Undergraduate Student} (since July 2026)

\hspace{-0.75cm}{\bf Yukai Wang}, \textit{Visiting Undergraduate Student} (since July 2026)

\hspace{-0.75cm}{\bf Jinchen Zhang}, \textit{Visiting Undergraduate Student} (since July 2026)
...
\textcolor{white}{} Undergraduate study committee at ND CSE (2024--2026) \\
\textcolor{white}{} Mentoring chair of an assistant professor at ND CSE (2024--\textit{present}) \\
...
\hspace{-0.75cm}{\bf Master's Dissertation Committee}

{\small

\textcolor{white}{.}{\bf Akriti Dhasmana}, Notre Dame Comp. Sci. \& Eng.
...
\textcolor{white}{.}{\bf Dr. Taicheng Guo}, Notre Dame Comp. Sci. \& Eng. \\
\textcolor{white}{.}{\bf Dr. Zhichun Guo}, Notre Dame Comp. Sci. \& Eng. \\
\textcolor{white}{.}{\bf Dr. Doheon Han}, Notre Dame Comp. Sci. \& Eng. \\
...
\textcolor{white}{.}{\bf Dr. Guoqiang Liu}, Notre Dame Biology \\
...
\textcolor{white}{.}{\bf Kehan Guo}, Notre Dame Comp. Sci. \& Eng. \\
\textcolor{white}{.}{\bf Shixiong Jiang}, Notre Dame Comp. Sci. \& Eng. \\
\textcolor{white}{.}{\bf Xiehong Jiang}, Notre Dame Comp. Sci. \& Eng. \\
...
\textcolor{white}{.}{\bf Chihiro Taguchi}, Notre Dame Comp. Sci. \& Eng. \\
\textcolor{white}{.}{\bf Xiangqi Wang}, Notre Dame Comp. Sci. \& Eng. \\
\textcolor{white}{.}{\bf Daniel Worae}, Notre Dame Comp. Sci. \& Eng. \\
\textcolor{white}{.}{\bf Gelei Xu}, Notre Dame Comp. Sci. \& Eng. \\
\textcolor{white}{.}{\bf Andy Yang}, Notre Dame Comp. Sci. \& Eng. \\
\textcolor{white}{.}{\bf Yujun Zhou}, Notre Dame Comp. Sci. \& Eng.
...
\hspace{-0.75cm}\textit{2026}\textcolor{white}{.}Co-Chair, the 1st Workshop on Continual Learning for Enterprise AI Agents at NeurIPS

\hspace{-0.75cm}\textit{2026}\textcolor{white}{.}Tutorial Chair, ACM SIGKDD Conference on Knowledge Discovery and Data Mining (KDD)

\hspace{-0.75cm}\textit{2026}\textcolor{white}{.}Co-Chair, the Workshop on Multilinguality in the Era of Large Language Models (MeLLMs) at ACL
...
\hspace{-0.75cm}{\bf (Senior) Program Committee / Reviewer}

{\small

ACM SIGKDD Int'l Conf. on Knowledge Discovery and Data Mining (KDD): \\
(PC: 2018--2021, SPC: 2022--2026)

ACM International Conference on Knowledge Management (CIKM): \\
(PC: 2017--2019, SPC: 2020--2026)

The Web Conference (TheWebConf/WWW): \\
(PC: 2018--2022, SPC/AC: 2023-2026)

ACL Rolling Review: \\
(Reviewer: Feb/Apr/June/Aug/Oct/Dec 2024, Feb/May 2025, AC: Oct 2025, Jan/Mar/May/Aug 2026)

International Conference on Web Search and Data Mining (WSDM): \\
(PC: 2019--2022, SPC: 2027)
...
Editor: {\small IEEE Bulletin of the Technical Committee on Data Engineering, December 2024, Vol. 48 No. 4: \url{http://sites.computer.org/debull/A24dec/issue1.htm}}
