...
\fancypagestyle{firststyle}
{
   ...
   \fancyhead[R]{\footnotesize Last updated June 26, 2023}
}
...
\item[W28] \textbf{Jiang, M.}, @Dang, H., @Tong, L. ``A Quantitative Review on Language Model Efficiency Research'', in the \textit{Large Language Model Symposium} in conjunction with \textit{International Joint Conference on Artificial Intelligence} (IJCAI), 2023.
