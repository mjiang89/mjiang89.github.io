...
\fancypagestyle{firststyle}
{
   ...
   \fancyhead[R]{\footnotesize Last updated November 18, 2025}
}
...
\item[J47] Mo, F., Gao, Y., Wu, Z., Liu, X., Chen, P., Li, Z., Wang, Z., Li, X., \textbf{Jiang, M.}, Nie, J. ``Leveraging Historical Information to Boost Retrieval-Augmented Generation in Conversations'', \textit{Information Processing and Management}. October 2025. (IF=6.9)
		
\item[J46] @Alosious, S., \textbf{Jiang, M.}, Luo, T. ``Computation and Machine Learning for Materials: Past, Present, and Future Perspectives'', \textit{MRS Bulletin: 50th Anniversary}, Springer Nature. September 2025. (IF=4.9; DOI: 10.1557/s43577-025-00959-y)
